<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Portal.Setup.Default" %>
        ...
        <tr>
            <td>
                <asp:Panel runat="server" ID="InstallPanel" class="sn-portlet">
                    <img class="toplogo" src="Install/installer-header.png" alt="DMIS" />
                    ...
                    <asp:UpdatePanel ID="updFooter" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="sn-pt-header">
                                ...
                                <asp:Image id="imgMessage" ImageUrl="Install/installer-portlet-caption-text-1.png" runat="server" AlternateText="DMIS Install" title="" />
                            </div>
                                ...
                                <div class="sn-pt-body-inner">                                
                                    <div style="overflow: hidden; zoom:1;">
                                        ...
                                        <asp:Panel ID="ErrorPanel" runat="server" Visible="false" CssClass="sn-errorpanel">
                                           ...
                                           You can check the error log or visit the community forum at <strong><a href="http://forum.com">forum.com</a></strong>
                                        </asp:Panel>
                                    </div>
                                </div>
                            </div>
                ...
                <asp:Panel ID="AppNameErrorPanel" runat="server" class="sn-portlet" Visible="false">
                    <div class="sn-pt-header">
                        <div class="sn-pt-arrow"></div>
                        <asp:Image id="Image1" ImageUrl="Install/installer-portlet-caption-text-2.png" runat="server" AlternateText="DMIS Install" title="" />
                    </div>
                     <div class="sn-pt-body-box">
                                <div class="sn-pt-body-inner">                                
                                    <div style="overflow: hidden; zoom:1; color:Black">
                                        <asp:Panel ID="Panel3" runat="server" >
                                            <strong>
                                           You have tried to install into a non-root virtual application folder. <br />
We apologize for the inconvenience, but needs to be installed into the web site root to run correctly. Please re-install into the web site root. <br />
