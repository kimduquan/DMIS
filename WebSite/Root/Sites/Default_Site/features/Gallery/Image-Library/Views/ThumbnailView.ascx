    ...
    <sn:ScriptRequest ID="ScriptRequest1" runat="server" Path="$skin/scripts/jquery/plugins/jquery.prettyPhoto.js" />
    ...
    <sn:ListGrid ID="ViewBody"
      ...
      <ItemTemplate>
        <asp:TableCell ID="TableCell1" runat="server" class="sn-gallery-cell">
          <a 
