    ...
    <EmptyDataTemplate>
          ...
          <span class="prev"><img src="/Root/Global/images/slides/arrow-prev.png" width="24" height="43" alt="<%=GetGlobalResourceObject("ContentView", "ArrowPrev")%>"></span>
        <span class="next"><img src="/Root/Global/images/slides/arrow-next.png" width="24" height="43" alt="<%=GetGlobalResourceObject("ContentView", "ArrowNext")%>"></span>          
        <div class="cr-thumbs">
          </div>
    </div>
