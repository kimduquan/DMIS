<%@ Control Language="C#" AutoEventWireup="false" Inherits="Portal.DiscussionForum.ForumView" %>
...
<div class="sn-forum-main">
    ...
    <% var isAllowedToAddNewTopic = Portal.Virtualization.PortalContext.Current.ContextNode.Security.HasPermission(ContentRepository.User.Current, ContentRepository.Storage.Schema.PermissionType.AddNew); %>
