<%@ Control Language="C#" AutoEventWireup="false" Inherits="Portal.DiscussionForum.TopicView" %>
...
<sn:DataSource ID="ViewDatasource" runat="server" ContextInfoID="ViewContext" />
<div class="sn-forum-topic">
    <% var isAllowedToAddNewComment = Portal.Virtualization.PortalContext.Current.ContextNode.Security.HasPermission(ContentRepository.User.Current, ContentRepository.Storage.Schema.PermissionType.AddNew); %>
