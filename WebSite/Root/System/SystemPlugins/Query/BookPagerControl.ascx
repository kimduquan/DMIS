<%@ Control Language="C#" AutoEventWireup="true"  Inherits="Portal.UI.Controls.PagerControl" %>
    ...
    <HeaderTemplate>
        ...
        CommandName="PageFirst">
            ...
            <span class="ui-button-text">
                <span><asp:Literal ID="Literal1" runat="server" Text="<%$ Resources: PagerControl, FirstPage%>" /></span>
            </span>
        </asp:LinkButton>
...
<asp:PlaceHolder ID="PageSizePanel" runat="server" >
    <b><%=GetGlobalResourceObject("PagerControl", "PageSize")%> </b>
...
&nbsp;&nbsp
<b><%=GetGlobalResourceObject("PagerControl", "TotalResultCount")%>: </b><%= this.ResultCount.ToString() %>
