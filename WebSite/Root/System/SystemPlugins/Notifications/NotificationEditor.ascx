...
<%@ Register Assembly="Portal" Namespace="Portal.UI.PortletFramework" TagPrefix="cbp" %>
<%@ Register Assembly="Portal" Namespace="Portal.Portlets" TagPrefix="nep" %>
...
%>
 <div class="sn-infobox" style="margin-bottom: 10px">
   <h1 class="sn-content-title" style="color: Black"><img src="/Root/Global/images/icons/32/warning.png" class="sn-icon sn-icon_32" alt=""><%= ContentRepository.i18n.ResourceManager.Current.GetString("Notification", "AttentionDefaultSettings")%></h1>
   <%= ContentRepository.i18n.ResourceManager.Current.GetString("Notification", "AttentionDetails")%>
 </div>
<%}%>
<%}%>

<% var targetContent = ContentRepository.Content.Load(this.Content["ContentPath"] as string); %>

<div class="sn-content-inlineview-header ui-helper-clearfix">
    <%= targetContent == null ? string.Empty : Portal.UI.IconHelper.RenderIconTag(targetContent.Icon, null, 32)%>
