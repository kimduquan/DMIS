<%@ Control Language="C#" AutoEventWireup="false" Inherits="Portal.UI.Controls.SurveyEditTemplatesUserControl" CodeBehind="SurveyEditTemplatesUserControl.cs" %>
...
<ul>
    <li>
        ...
        <asp:Button ID="btnEditLanding" runat="server" OnClick="BtnEdit_Click" CommandArgument="Landing" Visible="false" Text="<%$ Resources:Survey,Edit %>" />
    ...
    <li>
        ...
        <asp:Button ID="btnEditInvalidSurvey" runat="server" OnClick="BtnEdit_Click" CommandArgument="InvalidSurvey" Visible="false" Text="<%$ Resources:Survey,Edit %>" />
    ...
    <li>
        ...
        <asp:Button ID="btnEditMailTemplate" runat="server" OnClick="BtnEdit_Click" CommandArgument="MailTemplate" Visible="false" Text="<%$ Resources:Survey,Edit %>" />
