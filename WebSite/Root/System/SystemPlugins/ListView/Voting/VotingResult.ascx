<%@ Control Language="C#" AutoEventWireup="true" Inherits="Portal.UI.VotingResultContentView" %>
    ...
    <asp:ListView ID="ResultList" runat="server">
        ...
        <ItemTemplate>
                <div class="sn-iu-label">
                    <span class="sn-iu-title"><%# HttpUtility.HtmlEncode(Eval("Question")) %> (<%# Eval("Count") %>%)</span>
                </div>
