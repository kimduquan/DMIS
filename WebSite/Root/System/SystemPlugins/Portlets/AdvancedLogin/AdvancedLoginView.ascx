...
--%>                    <div class="sn-login-inner">
                    ...
                    <div class="sn-login-form-row">
                        ...
                        <strong><a class="sn-link sn-link-registration" href="/Publicregistration"><%= HttpContext.GetGlobalResourceObject("LoginPortlet","Registration") %></a></strong><br/>
            ...
            <div class="sn-panel">
                ...
                <div class="sn-userName">
                    <sn:ActionMenu id="UserActions" ContextInfoID="myContext" runat="server" Scenario="UserActions">
                        <%= ContentRepository.User.Current.FullName %>
                    </sn:ActionMenu>
                </div>   
