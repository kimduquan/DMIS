    ...
    <controltemplate>
                <asp:PlaceHolder ID="DialogHeader" runat="server">
                    ...
                    <p class="sn-lead sn-dialog-lead">
                        <asp:Label ID="DeleteOneLabel" runat="server" Text="<%$ Resources:CancelRegistration,CancelEventRegistration %>" Visible="false" /> 
                    </p>                          
    ...
    <footertemplate>
        ...
        <div class="sn-pt-body-border ui-widget-content sn-dialog-buttons">
            <div class="sn-pt-body">
                ...
                <asp:Label CssClass="sn-confirmquestion" ID="RusLabel" runat="server" Text="<%$ Resources:CancelRegistration,AreYouShure %>" />

                <asp:Button ID="OkBtn" runat="server" Text="<%$ Resources:CancelRegistration,Ok %>" CommandName="Ok" CssClass="sn-submit" Visible="false" /> 
                <asp:Button ID="YesBtn" runat="server" Text="<%$ Resources:CancelRegistration,Yes %>" CommandName="Yes" CssClass="sn-submit" Visible="true" /> 
                <asp:Button ID="NoBtn" runat="server" Text="<%$ Resources:CancelRegistration,No %>" CommandName="No" CssClass="sn-submit" Visible="true" /> 
                <asp:Button ID="CancelBtn" runat="server" Text="<%$ Resources:CancelRegistration,Cancel %>" CommandName="Cancel" CssClass="sn-submit" Visible="false" /> 
            </div>
        </div>
        <div class="sn-pt-footer"></div>    
    </footertemplate>
