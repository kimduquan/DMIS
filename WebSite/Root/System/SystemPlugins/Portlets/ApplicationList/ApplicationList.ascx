<%@ Control Language="C#" AutoEventWireup="false" Inherits="System.Web.UI.UserControl" %>
    ...
    <div onclick="$('.sn-applist').toggle(); $('.sn-applist-hidebutton').toggle(); $('.sn-applist-showbutton').toggle();">
        <div class="sn-applist-hidebutton" style='<%= (this.Parent as Portal.Portlets.ApplicationListPresenterPortlet).IsHidden ? "display: none" : "display: block" %>'>
        ...
        <div class="sn-applist-showbutton" style='<%= (this.Parent as Portal.Portlets.ApplicationListPresenterPortlet).IsHidden ? "display: block" : "display: none" %>'>
    ...
    <div class="sn-applist" style='<%= (this.Parent as Portal.Portlets.ApplicationListPresenterPortlet).IsHidden ? "display: none" : "display: block" %>'>
