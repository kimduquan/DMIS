...
<%
    ...
    var currentListc = ContentRepository.Content.Create(currentList);
     %>
        ...
        <div class="sn-inputunit ui-helper-clearfix">
            ...
            <div class="sn-iu-control">
                <ul class="sn-list">
                    ...
                    <li><sn:ActionLinkButton CssClass="sn-link" ActionName="ManageWorkflows" ContextInfoID="ContextInfoContent" ID="ManageWorkflowsLink" runat="server" IconVisible="False" ><%= SNSR.GetString("Controls", "Settings-ManageWorkflows") %></sn:ActionLinkButton></li>
                    <li><sn:ActionLinkButton CssClass="sn-link" ActionName="IncomingEmailSettings" ContextInfoID="ContextInfoContent" ID="IncomingEmailSettingsLink" runat="server" IconVisible="False" ><%= SNSR.GetString("Controls", "Settings-Email") %></sn:ActionLinkButton></li>
                </ul>
            </div>
        </div>
