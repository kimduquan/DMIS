<%@ Control Language="C#" AutoEventWireup="true" Inherits="Portal.Portlets.Controls.EventCalendar" %>
<asp:UpdatePanel runat="server" ID="UpdatePanel">
    <ContentTemplate>
        <div class="sn-calendar">
            <asp:Calendar ID="MyCalendar" runat="server"
                FirstDayOfWeek="Monday" NextMonthText="<%$ Resources:Calendar,Next %> &gt;" PrevMonthText="&lt; <%$ Resources:Calendar,Prev %>" ShowGridLines="True"
        ...
        <div class="sn-book-calendar-result"> 
            <asp:ListView ID="CalendarEventResult" runat="server">
                <LayoutTemplate>
                    <h3><%=GetGlobalResourceObject("Calendar", "Events")%>:</h3>
                ...
                <ItemTemplate>
                    <div class="sn-calendar-eventlist">
                        <span class="sn-calendar-event">
                            <sn:ActionLinkButton ID="eventTitle" runat="server" Text='<%# HttpUtility.HtmlEncode(Eval("DisplayName"))%>' ActionName="Browse" NodePath='<%# Eval("BrowseContentPath")%>' IconVisible="false" />
                        </span>
                        <br />
                        <span class="sn-calendar-time"><%=GetGlobalResourceObject("Calendar", "StartDate")%>: </span>
                        <asp:Label CssClass="sn-calendar-time" ID="startDate" runat="server" Text='<%# Eval("StartDate")%>' />
                        <br />
                        <span class="sn-calendar-time"><%=GetGlobalResourceObject("Calendar", "EndDate")%>: </span>
                        ...
                        <asp:MultiView ID="CalendarResultMultiView1" runat="server" ActiveViewIndex='<%# Eval("Registering")%>'>
                            <asp:View ID="NotRegisteredView" runat="server">
                                ...
                                <br />
                                <span class="sn-calendar-event">
                                    <sn:ActionLinkButton ID="ActionLinkButton1" runat="server" Text="<%$ Resources:Calendar,Register %>" ActionName="Add" NodePath='<%# Eval("BrowseContentPath")%>' IconVisible="false" />
                                </span>
                            </asp:View>
                            ...
                            <asp:View ID="RegisteredView" runat="server">
                                ...
                                <br />
                                <span class="sn-calendar-event">
                                    <sn:ActionLinkButton ID="ActionLinkButton2" runat="server" Text="<%$ Resources:Calendar,UnRegister %>" ActionName="Unregister" NodePath='<%# Eval("BrowseContentPath")%>' IconVisible="false" />
                                </span>
                            </asp:View>
                            ...
                            <asp:View ID="View1" runat="server">
                                ...
                                <asp:Label ID="IsRegistered" runat="server" CssClass="sn-calendar-event" Visible='<%# Eval("Visible")%>'>
                                    <sn:ActionLinkButton ID="ActionLinkButton3" runat="server" Text="<%$ Resources:Calendar,UnRegister %>" ActionName="Unregister" NodePath='<%# Eval("BrowseContentPath")%>' IconVisible="false" />
                                </asp:Label>
                            </asp:View>
                        </asp:MultiView>
                    </div>
