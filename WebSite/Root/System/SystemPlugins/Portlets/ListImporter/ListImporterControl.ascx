...
<div class="sn-importcsv">
    ...
    <div class="sn-inputunit ui-helper-clearfix">
        <div class="sn-iu-label">
            <span class="sn-iu-title">
                <asp:Label runat="server" Text='<%$ Resources:ListImporter,ChooseFile %>' AssociatedControlID="fuInputFile" />
            </span>
        </div>
    ...
    <div class="sn-inputunit ui-helper-clearfix">
        <div class="sn-iu-label">
            <span class="sn-iu-title"><%# ResourceManager.Current.GetString("ListImporterPortlet", "Options")%></span>
        </div>
        <div class="sn-iu-control">
    ...
    <asp:Panel ID="pnlResults" CssClass="sn-panel ui-state-default" runat="server" Visible="false">
        <h3 class="sn-content-subtitle"><%= ResourceManager.Current.GetString("ListImporterPortlet", "SuccesfullyImportedLabel") %></h3>
        <asp:ListView runat="server" ID="lvImported" >
            ...
            <EmptyDataTemplate>
                <p><%= ResourceManager.Current.GetString("ListImporterPortlet", "NoItems") %></p>
            </EmptyDataTemplate>
        </asp:ListView>

        <h3 class="sn-content-subtitle"><%= ResourceManager.Current.GetString("ListImporterPortlet", "NotImportedLabel") %></h3>
    ...
    <div class="sn-panel sn-buttons">
        ...
        <sn:BackButton runat="server" CssClass="sn-submit" ID="btnDone" Text="<%$Resources: ListImporterPortlet, Done%>" /><br />
    </div>
