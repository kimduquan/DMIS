    ...
    <div id="page1" class="snm-page">
        <div class="snm-pagecontent">
       	    <div class="snm-col snm-col-wide6">
    		    <h1><%=GetGlobalResourceObject("Tablet", "Welcome")%> <%= User.Current.FullName %>!</h1>
            </div>
    	    <div class="snm-col snm-col-wide3">
                <article class="snm-tile snm-tile-wide3 snm-right snm-profile">
                    ...
                    <section class="snm-tile">
                        <span class="snm-background"><img src="<%= Portal.UI.UITools.GetAvatarUrl(80, 80) %>" alt="" title="<%= ContentRepository.User.Current.FullName %>" /></span>
                    </section>
                </article>
            </div>
    	    <div class="snm-col">
