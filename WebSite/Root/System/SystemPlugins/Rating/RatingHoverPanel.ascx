<%@ Control Language="C#" AutoEventWireup="true" Inherits="Portal.UI.Controls.RatingHoverPanel" %>
<div class="rating-popup">
    <div class="rating-inside">
        <table cellspacing="0" cellpadding="0">
            <tr>
                <td>
                    <img src="/Root/Skins/dmis/images/rating-bf.png" />
                </td>
                <td class="rating-tooltip-bg">
                </td>
                <td>
                    <img src="/Root/Skins/dmis/images/rating-jf.png" />
                </td>
            </tr>
            <tr>
                <td class="rating-tooltip-bg">
                ...
                <td align="center" class="rating-tooltip-bg">
                    <div>
                        <strong><%=GetGlobalResourceObject("RatingHoverPanel", "Average")%>: </strong></div>
                    <div>
            ...
            <tr>
                <td>
                    <img src="/Root/Skins/dmis/images/rating-ba.png" />
                </td>
                <td class="rating-tooltip-bg">
                </td>
                <td>
                    <img src="/Root/Skins/dmis/images/rating-ja.png" />
                </td>
            </tr>
        </table>
    </div>
