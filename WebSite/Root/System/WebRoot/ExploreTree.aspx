...
<body class="sn-exploretree-body sn-admin">
        <form id="form1" runat="server">
            <div id="sn-exploretree-controls" class="ui-helper-clearfix">
                <span id="sn-exploretree-currentsite" style="display:none;"><%= (Portal.Virtualization.PortalContext.Current != null && Portal.Virtualization.PortalContext.Current.Site != null) ? Portal.Virtualization.PortalContext.Current.Site.Path : string.Empty %></span>
