...
<%  
    ...
    var currentUser = ContentRepository.User.Current as ContentRepository.User;    
    ...
    var mywallpath = Actions.ActionUrl(ContentRepository.Content.Create(currentUser), "Profile");
