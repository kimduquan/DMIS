<%@ Control Language="C#" AutoEventWireup="false" Inherits="Portal.Portlets.ContentCollection.MyContentCollectionView" %>
<div class="sn-forum-topic">
    ...
    <asp:Repeater ID="ContentList" runat="server">
        ...
        <ItemTemplate>
            <h3><asp:Label runat="server" ID="NameLabel" Text='<%# HttpUtility.HtmlEncode(Eval("DisplayName")) %>' /></h3>
