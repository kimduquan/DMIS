...
<div class="sn-workspace-list">
    ...
    <sn:Toolbar runat="server">
        <sn:ToolbarItemGroup Align="left" runat="server">
            ...
            <sn:ActionLinkButton runat="server" ActionName="Add" NodePath="/Root/Sites/Default_Site/workspaces/Project" ParameterString="ContentTypeName=/Root/ContentTemplates/ProjectWorkspace/Project_Workspace;backtarget=newcontent" Text="<%$ Resources:KPIRenderers,SalesWorkspace %>" />
            <sn:ToolbarSeparator runat="server" />    
