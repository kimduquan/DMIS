...
<ul class="sn-menu">
    ...
    <% if(Portal.Helpers.Security.IsInRole("Editors")){ %>
        <li class="sn-menu-0 sn-index-0"><sn:ActionLinkButton ID="alButton2" runat="server" IconVisible="true" ActionName="Add" Text="<%$ Resources: Portal, SnBlog_Menu_NewPost %>" ContextInfoID="ContextInfoWs" NodePath="Posts" IncludeBackUrl="true" ParameterString="ContentTypeName=BlogPost;backtarget=newcontent" /></li>
