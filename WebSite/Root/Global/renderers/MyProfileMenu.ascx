            ...
            <ul class="sn-menu">
                <li class="sn-menu-0 sn-index-0">
                    <a class="sn-actionlink" href="/" title="[home]">
                        ...
                        Site home<%=GetGlobalResourceObject("Renderers", "SiteHome")%></a></li>
                <li class="sn-menu-0 sn-index-0"><sn:ActionLinkButton ID="alButton0" runat="server" IconVisible="true" ActionName="Edit" UseContentIcon="true" Text="<%$ Resources:Renderers,EditProfile %>" ContextInfoID="ContextInfoUser" /></li>
                <li class="sn-menu-0 sn-index-0"><sn:ActionLinkButton ID="alButton1" runat="server" IconVisible="true" ActionName="Notifications" Text="<%$ Resources:Renderers,Notifications %>" ContextInfoID="ContextInfoUser" /></li>
                <li class="sn-menu-0 sn-index-0"><sn:ActionLinkButton ID="alButton2" runat="server" IconVisible="true" ActionName="SetPermissions" Text="<%$ Resources:Renderers,Premissions %>" ContextInfoID="ContextInfoCurrent" /></li>
            </ul>
        </div>
    </div>
</div>
