...
<%
    var currentContentPath = Portal.Virtualization.PortalContext.Current.ContextNodePath;
    var canSave = PortalContext.Current.ContextNode.Security.HasPermission(ContentRepository.User.Current, ContentRepository.Storage.Schema.PermissionType.Save);
%>
...
<div class="sn-upload-area">
    <div class="sn-upload-buttonbar">
        <div id="sn-upload-fileuploadbutton" class="sn-submit sn-notdisabled sn-upload-button">
            <span>
                <%= ResourceManager.Current.GetString("Action", "UploadAddFile")%></span>
    ...
    <div class="sn-upload-draganddrop">
        <%= ResourceManager.Current.GetString("Action", "UploadDragAndDropOneFile")%>
    </div>
...
<script>
    $(function () {
        ...
        var uploadEnabled = '<% PortalContext.Current.ContextNode.Security.HasPermission(ContentRepository.User.Current, ContentRepository.Storage.Schema.PermissionType.Save);%>';
        ...
        if (supportedBrowser()) {
            ...
            editor = $('#imageEditor').data('snImageEditor');
