...
<%--<%@ Register Assembly="VotingWebControlCaptcha" Namespace="Toolbox.WebControlCaptcha" TagPrefix="cap" %>--%>
<div class="sn-form ui-helper-clearfix">
     
    <h2 class="sn-form-title">
        <%= (this.Content.ContentHandler.Parent as Portal.Portlets.ContentHandlers.Form).DisplayName%>
    </h2>
    <div class="sn-form-description">
        <%= (this.Content.ContentHandler.Parent as Portal.Portlets.ContentHandlers.Form).Description%>
    </div>
