<%@  Language="C#" AutoEventWireup="true" Inherits="Portal.UI.SurveyGenericContentView" %>
...
<div class="sn-survey sn-content">
    ...
    <div class="sn-panel sn-buttons">
        ...
        <asp:PlaceHolder ID="PlcEmptySurvey" runat="server" Visible="false">
            ...
            <sn:BackButton ID="BackButton" Text="<%$ Resources:Content,Cancel %>" runat="server" CssClass="sn-button sn-submit" />
        </asp:PlaceHolder>
    </div>
</div>