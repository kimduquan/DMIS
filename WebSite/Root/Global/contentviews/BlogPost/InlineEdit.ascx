...
<div class="sn-content-inlineview">
    ...
    <div class="sn-article-content">        
        ...
        <div class="sn-blogpost-edit-lead sn-richtext">
          <h3><%= ContentRepository.i18n.ResourceManager.Current.GetString("Portal", "SnBlog_NewEditBlogPost_LeadingText")%></h3>
        ...
        <div class="sn-blogpost-edit-body sn-richtext">
          <h3><%= ContentRepository.i18n.ResourceManager.Current.GetString("Portal", "SnBlog_NewEditBlogPost_BodyText")%></h3>
