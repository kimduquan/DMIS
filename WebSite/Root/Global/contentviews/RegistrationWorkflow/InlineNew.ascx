...
%>
 <div class="sn-infobox" style="margin-bottom: 10px"> 
   <h1 class="sn-content-title" style="color: Black"><img src="/Root/Global/images/icons/32/warning.png" class="sn-icon sn-icon_32" alt=""><%= ContentRepository.i18n.ResourceManager.Current.GetString("RegistrationWorkflow", "AttentionDefaultSettings") %></h1>
   <%= ContentRepository.i18n.ResourceManager.Current.GetString("RegistrationWorkflow", "AttentionDetails")%>
 </div>
<%}%>
