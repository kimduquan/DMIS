...
<div class="sn-panel sn-buttons">
  <sn:CommandButtons ID="CommandButtons1" runat="server" CheckoutSaveCaption="<%$ Resources:ExpenseClaim, SaveClaimItem%>" SaveCaption="<%$ Resources:ExpenseClaim, SaveClaimItem%>"/>
</div>
