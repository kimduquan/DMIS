	...
	<div class="sn-view-top">
        <div class="sn-view-header">
            ...
            <div class="sn-view-header-text">
                <h2 class="sn-view-title"><%=GetGlobalResourceObject("Content", "CreateANew")%> <% = ContentTypeName %> <%=GetGlobalResourceObject("Content", "To")%></h2>
                <% = ParentPath %><%=GetGlobalResourceObject("Content", "Ba")%>
            </div>
        </div>
	</div>
