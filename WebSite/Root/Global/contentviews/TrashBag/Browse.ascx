...
<div class="sn-dialog-header sn-dialog-trashbag">
    ...
    <p class="sn-lead sn-dialog-lead">
        <%= Portal.UI.IconHelper.RenderIconTag(((TrashBag)this.Content.ContentHandler).DeletedContent.Icon, null, 32) %>
...
<sn:Toolbar ID="Toolbar1" runat="server">
    <sn:ToolbarItemGroup Align="left" runat="server">
        <% if ((this.Content.ContentHandler as TrashBag).DeletedContent is ContentRepository.File) { %>
