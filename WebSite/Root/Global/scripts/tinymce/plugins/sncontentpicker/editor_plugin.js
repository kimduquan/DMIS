(function () {
    ...
    tinymce.create('tinymce.plugins.ContentPickerPlugin', {
        ...
        getInfo: function () {
            return {
                longname: 'Content picker plugin for tinymce',
                author: 'sn',
                authorurl: 'http://www.com',
                infourl: 'http://www.com',
                version: '0.2'
            };
        }
    });
    ...
    // Register plugin
    tinymce.PluginManager.add('sncontentpicker', tinymce.plugins.ContentPickerPlugin);
})();