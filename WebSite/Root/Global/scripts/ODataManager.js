...
// This file is part of DMIS, the open source sharepoint alternative.
// License of this file is whatever license exists between you.

SN = typeof (SN) === "undefined" ? {} : SN;

// Class:
// Manages OData requests towards the Content Repository
SN.ODataManager = (function ($, undefined) {
    return function (constructorOptions) {
        ...
        // Property:
        // The data root of the DMIS OData service
        ...
        that.parseODataDate = function (value) {
            ...
            // If this is 0001.01.01 00:00:00 UTC then that means null
            if ((+d) === -62135596800000) {
                return null;
            }
        ...
        // Method:
        // Gets the URL that refers to a single item in the Content Repository
        ...
        // Method:
        // Gets content from the Content Repository via OData using the specified options.
        ...
        // Method:
        // Calls a custom action on the given content item in the Content Repository
        ...
        // Method:
        // Save the given content item to the Content Repository
        ...
        /* #region custom odata actions that are built into the core product */
        ...
        // Method:
        // Gets the permission entries of a content item from the Content Repository via OData using the specified options.
