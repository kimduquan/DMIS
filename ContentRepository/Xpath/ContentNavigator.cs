...
namespace ContentRepository.Xpath
{
    /// <summary>
    /// Provides an XmlAttribute accesing mechanism for the inner XPathNavigator.
    /// Implement this interface on a <see cref="ContentRepository.Field"/>
    ...
    /// Implement this interface on a <see cref="ContentRepository.Field"/> that contains
    ...
    /// Implement this interface on a <see cref="ContentRepository.Field"/> that has
    /// a complex XML structure.
    /// </summary>
    public interface IRawXmlContainer
    {
        /// <summary>
        /// Returns the <see cref="ContentRepository.Field"/>'s XML structure.
        /// </summary>
        /// <returns>String</returns>
        string GetRawXml();
    }
    ...
    /// <summary>
    /// Wrapper class of the <see cref="ContentRepository.Content"/>.
    ...
    public class NavigableContent : IXPathNavigable
    {
        ...
        /// </summary>
        /// <param name="content">Wrapped <see cref="ContentRepository.Content"/> instance.</param>
