    ...
    public class YesNoFieldSetting : ChoiceFieldSetting
    {
        ...
        public YesNoFieldSetting()
        {
            ...
            _options = new List<ChoiceOption>
                           {
                               new ChoiceOption(YesValue, ResourceManager.GetResourceKey("Ctd", "Enum-FieldSettingContent-YesNo-Yes")), 
                               new ChoiceOption(NoValue, ResourceManager.GetResourceKey("Ctd", "Enum-FieldSettingContent-YesNo-No"))
                           };
        }
