...
namespace ContentRepository.Fields
{
	...
	[DefaultFieldControl("Portal.UI.Controls.ReferenceGrid")]
    [FieldDataType(typeof(IEnumerable<Node>))]
	public class ReferenceField : Field, ContentRepository.Xpath.IXmlChildList
    {
		...
		{
            var wm = ContentRepository.Storage.Data.RepositoryConfiguration.WorkingMode;
            if (wm.Exporting)
