	...
	public class ChoiceOption
	{
		...
		public string Text
		{
			get
			{
                ...
                return ResourceManager.ParseResourceKey(_text ?? string.Empty, out className, out optionResourceKey) 
                    ? ResourceManager.Current.GetString(className, optionResourceKey) 
                    : _text;
			}
			set { _text = value; }
		}
