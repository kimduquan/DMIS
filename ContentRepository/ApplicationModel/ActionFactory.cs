...
namespace ApplicationModel
{
    internal class ActionFactory
    {
        ...
        private static UnityContainer GetUnityContainerForActions()
        {
            ...
            var actionTypes = TypeHandler.GetTypesByBaseType(actionBaseType);
            ...
            foreach (var actionType in actionTypes)
            {
                try
                {
                    ...
                    //E.g. register 'ApplicationModel.UploadAction' type with the name 'UploadAction' to
                ...
                {
                    Logger.WriteException(new Exception("Error during action type registration. Type name: " + actionType.FullName, ex));
                }
            }
