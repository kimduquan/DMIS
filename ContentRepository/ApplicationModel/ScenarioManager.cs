...
namespace ApplicationModel
{
    public class ScenarioManager
    {
        ...
        private static UnityContainer GetUnityContainerForScenarios()
        {
            ...
            var subTypes = TypeHandler.GetTypesByBaseType(baseType);
            ...
            foreach (var scenarioType in subTypes)
            {
                ...
                {
                    Logger.WriteException(new Exception("Error during scenario type registration. Type name: " + scenarioType.FullName, ex));
                }
            }
            ...
            foreach (var genScen in genericScenarios)
            {
                ...
                {
                    Logger.WriteException(new Exception("Error during scenario type registration. Type name: " + genScen, ex));
                } 
            }
