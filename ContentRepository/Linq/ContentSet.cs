...
namespace ContentRepository.Linq
{
    ...
    public class ContentSet<T> : IEnumerable<T>, IOrderedEnumerable<T>, IQueryable<T>, IOrderedQueryable<T>, IQueryProvider, ISnQueryable<T>
    {
        ...
        {
            throw new NotImplementedException("SnLinq: ContentSet.First");
        }
        public Content FirstOrDefault()
        {
            throw new NotImplementedException("SnLinq: ContentSet.FirstOrDefault");
        }
        ...
        {
            get { throw new NotImplementedException("SnLinq: ContentSet.ElementType"); }
        }
        ...
        {
            throw new NotImplementedException("SnLinq: ContentSet.Execute");
        }
        ...
        {
            throw new NotImplementedException("SnLinq: ContentSet.CreateOrderedEnumerable<TKey>");
        }
        ...
        private ContentSet<Q> Clone<Q>(System.Linq.Expressions.Expression expression)
        {
            ...
            if (typeof(Q) == typeof(Content) || typeof(ContentRepository.Storage.Node).IsAssignableFrom(typeof(Q)))
