...
namespace ContentRepository.Security
{
    public class MembershipProvider : System.Web.Security.MembershipProvider
    {
        ...
        {
            Logger.WriteInformation(EventId.SystemStart.MembershipProviderInstantiated, "MembershipProvider instantiated: " + typeof(ContentRepository.Security.MembershipProvider).FullName);
        }
        ...
        public override void Initialize(string name, System.Collections.Specialized.NameValueCollection config)
        {
            ...
            Logger.WriteVerbose("MembershipProvider initialized.", Logger.GetDefaultProperties, this);
        }
