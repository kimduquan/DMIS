...
namespace Search
{
    ...
    {
        private static string[] _headOnlyFields = ContentRepository.Storage.Node.GetHeadOnlyProperties();
        ...
        {
            var x = ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(GetFieldNameByPropertyName(propertyName));
            if (x != null)
        ...
        internal static QueryFieldLevel GetFieldLevel(IEnumerable<string> fieldNames)
        {
            ...
            {
                var indexingInfo = ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(fieldName);
        ...
        internal static QueryFieldLevel GetFieldLevel(string fieldName, PerFieldIndexingInfo indexingInfo)
        {
            ...
            if (fieldName == LucObject.FieldName.AllText)
                ...
                level = QueryFieldLevel.BinaryOrFullText;
            else if (indexingInfo.FieldDataType == typeof(ContentRepository.Storage.BinaryData))
                level = QueryFieldLevel.BinaryOrFullText;
