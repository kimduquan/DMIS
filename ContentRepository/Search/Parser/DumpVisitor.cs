...
namespace Search.Parser
{
    ...
    {
        public string Compile(Query query, int top, int skip, SortField[] orders, out ContentRepository.Storage.Search.NodeQueryParameter[] parameters)
        {
    ...
    internal class SqlWhereVisitor : LucQueryVisitor
    {
        ...
        private List<ContentRepository.Storage.Search.NodeQueryParameter> _parameters = new List<ContentRepository.Storage.Search.NodeQueryParameter>();
        public ContentRepository.Storage.Search.NodeQueryParameter[] Parameters
        {
        ...
        private void CompileTerm(Term t)
        {
            ...
            switch (fieldName)
            {
                ...
                case "InFolder":
                    ...
                    value = ContentRepository.Storage.NodeHead.Get(value).Id.ToString();
                    break;
                case "CreationDate":
            ...
            {
                _parameters.Add(new ContentRepository.Storage.Search.NodeQueryParameter { Name = paramName, Value = value });
        ...
        {
            var nodeType = ContentRepository.Storage.ActiveSchema.NodeTypes.Where(n => n.Name.ToLower() == typeName).FirstOrDefault();
            if (nodeType == null)
