...
namespace Search.Parser
{
    ...
    public class QueryFieldValue
    {
        ...
        internal QueryFieldValue(object value)
        {
            InputObject = value;
        }
    ...
    internal class SnLucParser
    {
        ...
        private class FieldInfo
        {
            ...
            bool _indexingInfoResolved;
            private PerFieldIndexingInfo _indexingInfo;
            public PerFieldIndexingInfo IndexingInfo
            {
                get
                {
                    ...
                    {
                        _indexingInfo = ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(this.Name);
        ...
        static string[] _headOnlyFields = ContentRepository.Storage.Node.GetHeadOnlyProperties();
