...
namespace Search.Indexing.Activities
{
    ...
    internal abstract class DistributedLuceneActivity : LuceneActivity
    {
        ...
        internal static void WriteMSMQLog(int activityid, MSMQLogStatusType statusType, int? addedBy)
        {
            ...
            var line = DateTime.UtcNow.Ticks.ToString() + ";" + DateTime.UtcNow.Hour.ToString() + ";" + DateTime.UtcNow.Minute.ToString() + ";" + DateTime.UtcNow.Second.ToString() + ";" + activityid.ToString() + ";" + status + ";";
        ...
        private static bool StartMSMQLog()
        {
            ...
            MSMQLogPath = string.Format(appSettingsMSMQLogPath, DateTime.UtcNow.ToString("yyyyMMddhhmmss"));
