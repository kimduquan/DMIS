...
using Diagnostics;
using SnD = Diagnostics;
using SnField = ContentRepository.Field;
using SnS = ContentRepository.Storage;
using SnSS = ContentRepository.Storage.Schema;
...
{
    public class IndexDocumentProvider : ContentRepository.Storage.Search.IIndexDocumentProvider
    {
    ...
    public class IndexDocumentInfo
    {
        ...
        internal static PerFieldIndexingInfo NameFieldIndexingInfo
        {
            get
            {
                ...
                {
                    var start = ContentRepository.Schema.ContentTypeManager.Current;
                    __nameFieldIndexingInfo = ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(LucObject.FieldName.Name);
                }
        ...
        internal static PerFieldIndexingInfo PathFieldIndexingInfo
        {
            get
            {
                ...
                {
                    var start = ContentRepository.Schema.ContentTypeManager.Current;
                    __pathFieldIndexingInfo = ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(LucObject.FieldName.Path);
                }
        ...
        internal static PerFieldIndexingInfo InTreeFieldIndexingInfo
        {
            get
            {
                ...
                {
                    var start = ContentRepository.Schema.ContentTypeManager.Current;
                    __inTreeFieldIndexingInfo = ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(LucObject.FieldName.InTree);
                }
        ...
        internal static PerFieldIndexingInfo InFolderFieldIndexingInfo
        {
            get
            {
                ...
                {
                    var start = ContentRepository.Schema.ContentTypeManager.Current;
                    __inFolderFieldIndexingInfo = ContentRepository.Schema.ContentTypeManager.GetPerFieldIndexingInfo(LucObject.FieldName.InFolder);
                }
    ...
    {
        IEnumerable<Fieldable> GetFields(ContentRepository.Storage.Data.IndexDocumentData docData);
    }
