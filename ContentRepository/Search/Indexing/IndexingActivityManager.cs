...
namespace Search.Indexing
{
    public sealed class IndexingDataContext : IndexingTasksDataContext
    {
        ...
        public IndexingDataContext(DbTransaction transaction) : base(transaction.Connection)
        {
    ...
    internal static class IndexingActivityManager
    {
        ...
        {
            var proc = ContentRepository.Storage.Data.DataProvider.CreateDataProcedure(@"DELETE FROM IndexingActivity");
        ...
        {
            return ContentRepository.Storage.Data.DataProvider.Current.GetLastActivityId();
        }
    }
}
