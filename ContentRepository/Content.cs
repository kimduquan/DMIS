...
namespace ContentRepository
{
    ...
    //}
    /// <summary>
    /// <c>Content</c> class is responsible for the general management of different types of <see cref="ContentRepository.Storage.Node">ContentHandler</see>s.
    /// </summary>
    /// <remarks>
    /// Through this class you can generally load, create, validate and save any kind 
    /// of <see cref="ContentRepository.Storage.Node">ContentHandlers</see>.
    /// 
    /// The type of a Content is defined by the <see cref="ContentRepository.Schema.ContentType">ContentType</see>, 
    /// which represents the ContentTypeDefinition. The most important component of a <c>Content</c> 
    /// is <see cref="ContentRepository.Field">Field</see> list, which is defined also in ContentTypeDefinition. 
    /// 
    /// Basically a <c>Content</c> is a wrapper of the <see cref="ContentRepository.Storage.Node">ContentHandler</see> assigned 
    /// when the <c>Content</c> itself was created, and the <see cref="ContentRepository.Field">Fields</see> are managing 
    ...
    public class Content : FeedContent, ICustomTypeDescriptor
    {
        ...
        /// <summary>
        /// Gets the <see cref="ContentRepository.Schema.ContentType">ContentType</see> of the instance.
        /// </summary>
        ...
        /// <summary>
        /// Gets the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see> of the instance.
        /// </summary>
        public Node ContentHandler
        {
            get { return _contentHandler; }
        }
        public ContentRepository.Storage.Security.SecurityHandler Security
        {
        ...
        public ChildrenDefinition ChildrenDefinition
        {
            get
            {
                ...
                throw new NotImplementedException("Only GenericContent and ContentType support ChildrenDefinition.");
            }
            set
            {
                var ct = ContentHandler as ContentType;
        ...
        /// <summary>
        /// Gets the Id of the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        /// </summary>
        public int Id
        {
        ...
        /// <summary>
        /// Gets the path of the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        /// </summary>
        public string Path
        {
        ...
        /// <summary>
        /// Gets the name of the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        /// </summary>
        public string Name
        {
        ...
        /// <summary>
        /// Gets or sets the value of an indexed <see cref="ContentRepository.Field">Field</see>. 
        /// Type of return value is determined by derived <see cref="ContentRepository.Field">Field</see>.
        /// </summary>
        /// <param name="fieldName"></param>
        /// <returns>An <see cref="System.Object">object</see> that represents the <see cref="ContentRepository.Field">Field</see>'s value.</returns>
        ...
        /// <summary>
        /// Loads the appropiate <see cref="ContentRepository.Storage.Node">ContentHandler</see> by the given ID and wraps to a <c>Content</c>.
        /// </summary>
        /// <returns>The latest version of the <see cref="ContentRepository.Storage.Node">ContentHandler</see> that has the given ID wrapped by a <c>Content</c> instance.</returns>
        ...
        /// <summary>
        /// Loads the appropiate <see cref="ContentRepository.Storage.Node">ContentHandler</see> by the given Path and wraps to a <c>Content</c>.
        /// </summary>
        /// <returns>The latest version of the <see cref="ContentRepository.Storage.Node">ContentHandler</see> that has the given Path wrapped by a <c>Content</c> instance.</returns>
        ...
        /// <summary>
        /// Loads the appropiate <see cref="ContentRepository.Storage.Node">ContentHandler</see> by the given ID and version number and wraps to a <c>Content</c>.
        /// </summary>
        /// <returns>The given version of the <see cref="ContentRepository.Storage.Node">ContentHandler</see> that has the given ID wrapped by a <c>Content</c>.</returns>
        ...
        /// <summary>
        /// Loads the appropiate <see cref="ContentRepository.Storage.Node">ContentHandler</see> by the given Path and version number and wraps to a <c>Content</c>.
        /// </summary>
        /// <returns>The given version of the <see cref="ContentRepository.Storage.Node">ContentHandler</see> that has the given Path wrapped by a <c>Content</c>.</returns>
        ...
        public static Content LoadByIdOrPath(string idOrPath)
        {
            ...
            int contentId;
            if (Int32.TryParse(idOrPath, out contentId))
                return Content.Load(contentId);

            if (RepositoryPath.IsValidPath(idOrPath) == RepositoryPath.PathResult.Correct)
                return Content.Load(idOrPath);

            return null;
        }

        /// <summary>
        /// Executes the given <see cref="ContentRepository.Storage.Search.NodeQuery">NodeQuery</see> and wraps each <see cref="ContentRepository.Storage.Node">ContentHandler</see> to a <c>Content</c>.
        /// </summary>
        /// <returns>A Content list that is contain the result <see cref="ContentRepository.Storage.Node">ContentHandler</see>s wrapped by a <c>Content</c>.</returns>
        ...
        /// <summary>
        /// Creates a <c>Content</c> instance from an instantiated <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        /// </summary>
        /// <returns>Passed <see cref="ContentRepository.Storage.Node">ContentHandler</see> wrapped by a <c>Content</c>.</returns>
        ...
        /// <summary>
        /// Creates an appropriate new <see cref="ContentRepository.Storage.Node">ContentHandler</see> instance by the given parameters ant wraps to a <c>Content</c>.
        /// This method calls the appropriate constructor determined by the passed arguments but do not saves the new <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        /// </summary>
        /// <param name="contentTypeName">Determines the type of <see cref="ContentRepository.Storage.Node">ContentHandler</see>. 
        /// Fully qualified type name is contained by the <see cref="ContentRepository.Schema.ContentType">ContentType</see> named this parameter's value.
        /// </param>
        /// <param name="parent"><see cref="ContentRepository.Storage.Node">ContentHandler</see> instance as a parent in the big tree.</param>
        /// <param name="name">The expected name of the new <see cref="ContentRepository.Storage.Node">ContentHandler</see>.</param>
        /// <param name="args">Additional parameters required by the expected constructor of <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        /// In this version neither argument can be null.</param>
        /// <returns>An instantiated <see cref="ContentRepository.Storage.Node">ContentHandler</see> wrapped by a <c>Content</c>.</returns>
                ...
                while (true)
                {
                    try
                    {
                        ...
                        if (nodeCreateException != null)
                            Logger.WriteWarning(Logger.EventId.NotDefined, "Error during node creation: " + Tools.CollectExceptionMessages(nodeCreateException));
        ...
        /// <summary>
        /// Returns an array contains all existing <see cref="ContentRepository.Schema.ContentType">ContentType</see> name.
        /// </summary>
        ...
        /// <summary>
        /// Valiadates each contained <see cref="ContentRepository.Field">Field</see>s and returns <c>true</c> if all fields are valid.
        /// </summary>
        /// <returns>It is <c>true</c> if all contained <see cref="ContentRepository.Field">Field</see>s are valid; otherwise, <c>false</c>.</returns>
        ...
        /// <summary>
        /// Validates and saves the wrapped <c>ContentHandler</c> into the Content Repository with considering the versioning settings.
        /// </summary>
        /// <remarks>
        /// This method executes followings:
        /// <list type="bullet">
        ///     <item>
        ///         Saves all <see cref="ContentRepository.Field">Field</see>s into the properties 
        ///         of wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        ///     </item>
        ///     <item>
        ///         If <c>Content</c> is not valid 
        ///         throws an <see cref="ContentRepository.InvalidContentException">InvalidContentException</see>.
        ///     </item>
        ///     <item>
        ///         Saves the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see> into the Content Repository.
        ///     </item>
        /// </list>
        /// 
        /// If the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see> inherited from 
        /// the <see cref="ContentRepository.GenericContent">GenericContent</see> after the saving
        /// its version is depends its <see cref="ContentRepository.GenericContent.VersioningMode">VersioningMode</see> setting.
        /// </remarks>
        ...
        /// <summary>
        /// Saves the wrapped <c>ContentHandler</c> into the Content Repository with considering the versioning settings.
        /// </summary>
        /// <remarks>
        /// This method executes followings:
        /// <list type="bullet">
        ...
        /// <summary>
        /// Validates and saves the wrapped <c>ContentHandler</c> into the Content Repository without considering the versioning settings.
        /// </summary>
        /// <remarks>
        /// This method executes followings:
        /// <list type="bullet">
        ...
        ///     </item>
        ///     <item>
        ///         If <c>Content</c> is not valid throws an <see cref="ContentRepository.InvalidContentException">InvalidContentException</see>.
        ///     </item>
        ///     <item>
        ///         Saves the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see> into the Content Repository.
        ///     </item>
        /// </list>
        /// 
        /// After the saving the version of wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see> will not changed.
        /// </remarks>
        /// <exception cref="InvalidContentException">Thrown when <c>Content</c> is invalid.</exception>
        ...
        ///     <item>
        ///         If the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see> inherited from 
        ///         the <see cref="ContentRepository.GenericContent">GenericContent</see> calls its
        ///         <see cref="ContentRepository.GenericContent.Publish">Publish</see> method otherwise saves it normally.
        ///     </item>
        /// </list>
        /// </remarks>
        /// <exception cref="InvalidContentException">Thrown when <c>Content</c> is invalid.</exception>
        ...
        /// <summary>
        /// Saves all <see cref="ContentRepository.Field">Field</see>s into the properties of wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see>.
        /// 
        /// If <c>Content</c> is not valid throws an <see cref="ContentRepository.InvalidContentException">InvalidContentException</see>.
        /// 
        /// If the wrapped <see cref="ContentRepository.Storage.Node">ContentHandler</see> inherited from 
        /// the <see cref="ContentRepository.GenericContent">GenericContent</see> calls its
        /// <see cref="ContentRepository.GenericContent.CheckIn">CheckIn</see> method otherwise calls the
        /// <see cref="ContentRepository.Storage.Node.Lock.Unlock">Unlock</see> method with
        /// <c><see cref="ContentRepository.Storage.VersionStatus">VersionStatus</see>.Public</c> and 
        /// <c><see cref="ContentRepository.Storage.VersionRaising">VersionRaising</see>.None</c> parameters.
        /// 
        /// </summary>
        /// <remarks>
        /// This method executes followings:
        ...
        /// 		the <see cref="ContentRepository.GenericContent">GenericContent</see> calls its
        /// 		<see cref="ContentRepository.GenericContent.CheckIn">CheckIn</see> method otherwise calls the
        /// 		<see cref="ContentRepository.Storage.Node">ContentHandler</see>'s
        /// 		<see cref="ContentRepository.Storage.Security.LockHandler.Unlock(VersionStatus, VersionRaising)">Lock.Unlock</see> method with
        /// 		<c><see cref="ContentRepository.Storage.VersionStatus">VersionStatus</see>.Public</c> and 
        /// 		<c><see cref="ContentRepository.Storage.VersionRaising">VersionRaising</see>.None</c> parameters.
        ///     </item>
        /// </list>
        ...
        public void ForceUndoCheckOut()
        {
            using (var traceOperation = Logger.TraceOperation("Content.ForceUndoCheckOut"))
            {
                if (!SavingAction.HasForceUndoCheckOutRight(this.ContentHandler))
                    throw new Storage.Security.SecurityException(this.Path, Storage.Schema.PermissionType.ForceCheckin);
        ...
        /// <summary>
        /// Deletes the represented <see cref="ContentRepository.Storage.Node">Node</see> and all of its contents from the database. This operation removes all child nodes too.
        /// </summary>
        ...
        public bool InFolder(string path) { return path.Equals(RepositoryPath.GetParentPath(Path), StringComparison.OrdinalIgnoreCase); }
        ...
        public bool InTree(Content content) { return InFolder(content.Path); }
        ...
        private void WriteXmlHeaderAndFields(XmlWriter writer, SerializationOptions options)
        {
            ...
            base.WriteHead(writer, this.ContentType.Name, ResourceManager.Current.GetString(this.ContentType.DisplayName), this.Name, this.ContentType.Icon, this.Path, this.ContentHandler is IFolder);
        ...
        private IEnumerable<string> GetFieldNamesInTable(Node content)
        {
            ...
            var dynamicContentTypes = types.Where(x => typeof(ISupportsDynamicFields).IsAssignableFrom(TypeHandler.GetType(x.HandlerName))).ToArray();
            if (dynamicContentTypes.Length > 0)
            {
                var results = ContentQuery.Query(SafeQueries.InFolderAndTypeIs,
                    new QuerySettings { EnableAutofilters = FilterStatus.Enabled },
        ...
        {
            ContentHandler.AddReferences(GenericContent.ASPECTS, aspects);
            RebuildAspectFields();
        }
        ...
        {
            ContentHandler.AddReferences(GenericContent.ASPECTS, new NodeList<Aspect>(aspectIds));
            RebuildAspectFields();
        }
                            ...
                            if (!string.IsNullOrEmpty(xmlSrc))
                            {
                                ...
                                foreach (XmlElement element in xml.DocumentElement.ChildNodes)
                                {
                                    ...
                                    if (AspectFields.TryGetValue(name, out field))
                                    {
                                        ...
                                        {
                                            // Can't parse field - value is treated as null
                                            // This feature is UNDONE
