...
namespace ContentRepository.Json
{
    /// <summary>
    ...
    public static class JsonDynamicFieldHelper
    {
        ...
        /// NOTE: only those properties will be made into field metadata which have a direct counterpart.
        /// </summary>
        ...
        public static object GetProperty(JObject jObject, string name, out bool found, Type typeWanted = null)
        {
            ...
            if (token == null)
                return null;
            if (!(token is JValue))
                throw new NotImplementedException("Can't get value from the specified token.");
