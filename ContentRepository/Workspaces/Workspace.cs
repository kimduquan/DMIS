...
namespace ContentRepository.Workspaces
{
    [ContentHandler]
    public class Workspace : Folder
    {
        ...
        public IEnumerable<IUser> GetWorkspaceMembers()
        {
            ...
            var workspaceGroups = ContentQuery.Query(SafeQueries.InTreeAndTypeIs, settings, groupFolderPath, typeof(Group).Name).Nodes;
