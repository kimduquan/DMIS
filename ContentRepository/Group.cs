...
namespace ContentRepository
{
    ...
    public class Group : GenericContent, IGroup, IADSyncable
    {
        ...
        {
            get { return (Group)Node.LoadNode(RepositoryConfiguration.OperatorsGroupPath); }
        }
        ...
        {
            AssertSpecialGroup("Cannot add any member to {0} group.");
        ...
        {
            AssertSpecialGroup("Cannot remove any member from {0} group.");
        ...
        {
            if (this.Id != RepositoryConfiguration.EveryoneGroupId &&
                this.Id != RepositoryConfiguration.CreatorsGroupId &&
                this.Id != RepositoryConfiguration.LastModifiersGroupId)
                return;
        ...
        protected void AssertValidMembers()
        {
            ...
            if (RepositoryConfiguration.SpecialGroupPaths.Contains(this.Path))
            {
        ...
        //=================================================================================== Events
        protected override void OnMoving(object sender, ContentRepository.Storage.Events.CancellableNodeOperationEventArgs e)
        {
            // AD Sync check
            var ADProvider = DirectoryProvider.Current;
            if (ADProvider != null)
