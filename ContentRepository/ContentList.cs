...
namespace ContentRepository
{
	...
	public class ContentList : Folder, IContentList
	{
        ...
        private static readonly string ContentListDefinitionXmlNamespaceOld = "http://schemas" + ".hu/ContentRepository/Lis"+"terTypeDefinition";
		public static readonly string ContentListDefinitionXmlNamespace = "http://schemas.com/ContentRepository/ContentListDefinition";
        private static string ContentListDefinitionSchemaManifestResourceName = "ContentRepository.Schema.ContentListDefinition.xsd";
