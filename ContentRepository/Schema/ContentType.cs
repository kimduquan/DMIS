...
namespace  ContentRepository.Schema
{
    ...
    public class ContentType : Node, IFolder, IIndexableDocument
    {
        ...
        internal static readonly string ContentDefinitionXmlNamespaceOld = "http://schemas" + ".hu/ContentRepository/ContentTypeDefinition";
        public static readonly string ContentDefinitionXmlNamespace = "http://schemas.com/ContentRepository/ContentTypeDefinition";
        private static string ContentTypeDefinitionSchemaManifestResourceName = "ContentRepository.Schema.ContentTypeDefinition.xsd";
        ...
        /// <summary>
        /// Returns the <see cref="ContentRepository.Schema.FieldSetting">FieldSetting</see> by passed field name.
        /// </summary>
        /// <param name="fieldName">Inherited or owned Field name.</param>
        /// <returns>Null or <see cref="ContentRepository.Schema.FieldSetting">FieldSetting</see></returns>
        ...
        /// <summary>
        /// Gets the child <see cref="ContentRepository.Schema.ContentType">ContentTypes</see> in an <see cref="System.Collections.Generic.IEnumerable">IEnumerable</see>&lt;<see cref="ContentRepository.Storage.Node">Node</see>&gt;.
        /// </summary>
        ...
        /// <summary>
        /// Returns the <see cref="ContentRepository.Schema.ContentType">ContentType by requested name.</see> 
        /// </summary>
        /// <param name="contentTypeName">Name of the requested <see cref="ContentRepository.Schema.ContentType">ContentType</see></param>
        /// <returns><see cref="ContentRepository.Schema.ContentType">ContentType</see></returns>
        ...
        /// <summary>
        /// Returns an array of <see cref="ContentRepository.Schema.ContentType">ContentTypes</see> 
        /// thats have not parent <see cref="ContentRepository.Schema.ContentType">ContentType</see>
        /// </summary>
        /// <returns><see cref="ContentRepository.Schema.ContentType">ContentType</see> array</returns>
        public static ContentType[] GetRootTypes()
        {
            return ContentTypeManager.Current.GetRootTypes();
        }
        /// <summary>
        /// Returns an array of <see cref="ContentRepository.Schema.ContentType">ContentType</see> names
        /// thats have not parent <see cref="ContentRepository.Schema.ContentType">ContentType</see>.
        /// </summary>
        ...
        /// <summary>
        /// Returns an array of every <see cref="ContentRepository.Schema.ContentType">ContentTypes</see> 
        /// </summary>
        /// <returns><see cref="ContentRepository.Schema.ContentType">ContentType</see> array</returns>
        ...
        /// <summary>
        /// Returns an array of every <see cref="ContentRepository.Schema.ContentType">ContentType</see> names
        /// </summary>
        /// <returns><see cref="System.String">String</see> array</returns>
        ...
        public static string TracePerFieldIndexingInfo()
        {
            ...
            foreach (var item in ContentTypeManager.GetPerFieldIndexingInfo())
            {
                ...
                sb.AppendLine(item.Value.IndexFieldHandler.GetType().FullName.Replace("Search.", String.Empty));
            }
            return sb.ToString();
        }
    }
