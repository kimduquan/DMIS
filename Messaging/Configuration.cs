...
namespace Messaging
{
    ...
    {
        private const string SECTIONNAME = "dmis/notification";
        ...
        private static void Parse()
        {
            ...
            else
            {
                ...
                ParseGroupByUser(GROUPBYUSERKEY);
...
or 'Last Weekday Hour:Minute' (e.g. 'Last Sunday 23:00'), or 'Every Day. Hour:Minute' (e.g. 'Every 10. 23:10')");
        ...
        private static void ParseEncoding(string setting)
        {
            ...
            {
                Logger.WriteError(Logger.EventId.NotDefined, String.Format("The configured value: {0} is not a valid code page name. Default encoding is set: {1}.", setting, DefaultMessageEncoding.BodyName));
                MessageEncoding = DefaultMessageEncoding;
            }
        }
