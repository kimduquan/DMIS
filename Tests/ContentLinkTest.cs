...
namespace ContentRepository.Tests
{
    ...
    public class ContentLinkTest : TestBase
    {
        ...
        public void ContentLink_WithMovedReference()
        {
            ...
            EnsureNode("[TestRoot]/SystemFolder5");

            SetContentLink("[TestRoot]/ContentLink5", LoadNode("[TestRoot]/GenericContent5"));

            MoveNode("[TestRoot]/GenericContent5", "[TestRoot]/SystemFolder5");

            CheckContentLink("[TestRoot]/ContentLink5", "[TestRoot]/SystemFolder5/GenericContent5");
        }
