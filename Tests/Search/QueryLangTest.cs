...
namespace ContentRepository.Tests.Search
{
    ...
    public class QueryLangTest : TestBase
    {
        ...
        public void NodeQuery_BuildFromXml()
        {
            ...
            query.Add(dtExp);
            dtExp.Add(new DateTimeExpression(DateTimeAttribute.CreationDate, ValueOperator.Equal, DateTime.UtcNow));
            ...
            dtExp.Add(new DateTimeExpression(dateTimeSlot1, ValueOperator.Equal, DateTime.UtcNow));
            ...
            subExp.Add(new DateTimeExpression(DateTimeAttribute.CreationDate, ValueOperator.GreaterThan, DateTime.UtcNow));
