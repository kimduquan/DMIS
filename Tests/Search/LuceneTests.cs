...
namespace ContentRepository.Tests.Search
{
    ...
    public class LuceneTests : TestBase
    {
        ...
        public void Lucene_Depth()
        {
            ...
            var query = ContentQuery.CreateQuery(qtext);
        ...
        private string[] GetPathArray(QueryResult result)
        {
        ...
        private Folder CreateStructureForQueryExecutor20100701_Paging(out Folder[] folders)
        {
            ...
            if (rootFolder != null)
            {
                folders = Search.ContentQuery.Query("InFolder:" + rootPath).Nodes.Cast<Folder>().ToArray();
                return rootFolder;
            }
        ...
        private string ViewLucObjects(IEnumerable<LucObject> docs)
        {
            var sb = new StringBuilder();
