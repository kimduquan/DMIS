...
namespace ContentRepository.Tests.Search
{
    ...
    public class DataSourceTest : TestBase
    {
        ...
        public void SnDataSource_Execute_WithSystemFiles()
        {
            ...
            var snds = new DataSource { Query = "InTree:" + _testRootPath };
            ...
            snds = new DataSource
                       {
                           ...
                           Settings = new QuerySettings { EnableAutofilters = FilterStatus.Disabled }
                       };
        ...
        public void SnDataSource_Execute_Top1()
        {
            ...
            //create a datasource to query simple content
            var snds = new DataSource {ContentPath = _testRootPath, Top = 2};
            var results = snds.Select(DataSourceSelectArguments.Empty);
        ...
        public void SnDataSource_Execute_Flatten1()
        {
            ...
            //create a datasource to query simple content
            var snds = new DataSource { ContentPath = _testRootPath, FlattenResults = true };
            var results = snds.Select(DataSourceSelectArguments.Empty);
