...
using ContentRepository.Tests.Data;
using Lucene.Net.Documents;
using Lucene.Net.Index;

namespace ContentRepository.Tests.Search
{
    [TestClass]
    public class IndexingHistorytests : TestBase
    {
        ...
        public void IndexingHistory_FixUpdateAddOverlap()
        {
            ...
            var historyOk = LuceneManager._history.IsVersionCanBeUpdated(versionId1, timestamp1);
            ...
            historyOk = LuceneManager._history.IsVersionCanBeAdded(versionId2, timestamp2);
            ...
            var firstfound = ContentQuery.Query("Description:" + fieldvalue1, new QuerySettings { EnableAutofilters = FilterStatus.Disabled }).Count;
            var secondfound = ContentQuery.Query("Description:" + fieldvalue2, new QuerySettings { EnableAutofilters = FilterStatus.Disabled }).Count;
            ...
            var detectChange1 = history.IsVersionChanged(versionId1, timestamp1);
        ...
        public void IndexingHistory_FixAddAddOverlap()
        {
            ...
            var versionId1 = history.GetVersionId(document1);
            var timestamp1 = history.GetTimestamp(document1);
            var historyOk = LuceneManager._history.IsVersionCanBeAdded(versionId1, timestamp1);
        ...
        public void IndexingHistory_FixDeleteAddOverlap()
        {
            ...
            var versionId2 = history.GetVersionId(document2);
            var timestamp2 = history.GetTimestamp(document2);
            var historyOk = LuceneManager._history.IsVersionCanBeAdded(versionId2, timestamp2);
        ...
        public void IndexingHistory_FixDeleteUpdateOverlap()
        {
            ...
            var versionId2 = history.GetVersionId(document2);
            var timestamp2 = history.GetTimestamp(document2);
            var historyOk = LuceneManager._history.IsVersionCanBeUpdated(versionId2, timestamp2);
        ...
        public void IndexingHistory_FixUpdateUpdateOverlap()
        {
            ...
            var versionId2 = history.GetVersionId(document2);
            var timestamp2 = history.GetTimestamp(document2);
            historyOk = LuceneManager._history.IsVersionCanBeUpdated(versionId2, timestamp2);
            ...
            firstfound = ContentQuery.Query("Description:" + fieldvalue1, new QuerySettings { EnableAutofilters = FilterStatus.Disabled }).Count;
            ...
            var detectChange2 = history.IsVersionChanged(versionId2, timestamp2);
        ...
        public void IndexingHistory_FixAddDeleteOverlap()
        {
            ...
            using(new ContentRepository.Storage.Security.SystemAccount())
                firstfound = ContentQuery.Query(SafeQueries.Description, new QuerySettings { EnableAutofilters = FilterStatus.Disabled }, fieldvalue1).Count;
        ...
        public void IndexingHistory_CheckForAdd()
        {
            ...
            Assert.IsTrue(history.IsVersionCanBeAdded(42, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(42, 1111) first call returned with false");
            Assert.IsFalse(history.IsVersionCanBeAdded(42, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(42, 1111) second call returned with true");
            Assert.IsFalse(history.IsVersionCanBeAdded(42, new Timestamps(1110, 1110)), "IsVersionCanBeAdded(42, 1110) returned with true");
            Assert.IsFalse(history.IsVersionCanBeAdded(42, new Timestamps(1112, 1112)), "IsVersionCanBeAdded(42, 1112) returned with true");

            Assert.IsTrue(history.IsVersionCanBeAdded(43, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(43, 1111) first call returned with false");
            Assert.IsFalse(history.IsVersionCanBeAdded(43, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(43, 1111) second call returned with true");
            Assert.IsFalse(history.IsVersionCanBeAdded(43, new Timestamps(1110, 1110)), "IsVersionCanBeAdded(43, 1110) returned with true");
            Assert.IsFalse(history.IsVersionCanBeAdded(43, new Timestamps(1112, 1112)), "IsVersionCanBeAdded(43, 1112) returned with true");

            Assert.IsTrue(history.Count == 2, string.Format("history.Count is {0}, expected: 2 (size: {1})", history.Count, size));

            Assert.IsTrue(history.IsVersionCanBeAdded(44, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(44, 1111) returned with false");
            Assert.IsTrue(history.IsVersionCanBeUpdated(44, new Timestamps(1112, 1112)), "IsVersionCanBeUpdated(44, 1112) returned with false");
            Assert.IsFalse(history.IsVersionCanBeAdded(44, new Timestamps(1113, 1113)), "IsVersionCanBeAdded(44, 1113) rreturned with true");
        }
        [TestMethod]
        public void IndexingHistory_CheckForUpdate()
        {
            ...
            Assert.IsTrue(history.IsVersionCanBeUpdated(42, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(42, 1111) first call returned with false");
            Assert.IsFalse(history.IsVersionCanBeUpdated(42, new Timestamps(1111, 1111)), "IsVersionCanBeUpdated(42, 1111) second call returned with true");
            Assert.IsFalse(history.IsVersionCanBeUpdated(42, new Timestamps(1110, 1110)), "IsVersionCanBeUpdated(42, 1110) returned with true");
            Assert.IsTrue(history.IsVersionCanBeUpdated(42, new Timestamps(1112, 1112)), "IsVersionCanBeUpdated(42, 1112) returned with false");
            Assert.IsTrue(history.IsVersionCanBeUpdated(42, new Timestamps(1113, 1113)), "IsVersionCanBeUpdated(42, 1113) returned with false");

            Assert.IsTrue(history.IsVersionCanBeUpdated(43, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(43, 1111) first call returned with false");
            Assert.IsFalse(history.IsVersionCanBeUpdated(43, new Timestamps(1111, 1111)), "IsVersionCanBeUpdated(43, 1111) second call returned with true");
            Assert.IsFalse(history.IsVersionCanBeUpdated(43, new Timestamps(1110, 1110)), "IsVersionCanBeUpdated(43, 1110) returned with true");
            Assert.IsTrue(history.IsVersionCanBeUpdated(43, new Timestamps(1112, 1112)), "IsVersionCanBeUpdated(43, 1112) returned with false");
            Assert.IsTrue(history.IsVersionCanBeUpdated(43, new Timestamps(1113, 1113)), "IsVersionCanBeUpdated(43, 1113) returned with false");
        ...
        public void IndexingHistory_ProcessDelete()
        {
            ...
            Assert.IsFalse(history.IsVersionCanBeAdded(42, new Timestamps(1111, 1111)), "IsVersionCanBeAdded(42, 1111) returned with true");
            Assert.IsFalse(history.IsVersionCanBeUpdated(42, new Timestamps(1112, 1112)), "IsVersionCanBeUpdated(42, 1112) returned with true");
