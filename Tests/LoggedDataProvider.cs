...
{
    internal class LoggedDataProvider : ContentRepository.Storage.Data.SqlClient.SqlProvider, IDisposable
    {
        ...
        {
            _wrapped = (ContentRepository.Storage.Data.SqlClient.SqlProvider)DataProvider.Current;
        ...
        protected internal override System.IO.Stream LoadStream(int versionId, int propertyTypeId)
        {
            return base.LoadStream(versionId, propertyTypeId);
        }
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod(), sourceNodeId, targetNodeId, sourceTimestamp, targetTimestamp);
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod(), nodeId, timestamp);
        ...
        protected internal override IDataProcedure CreateDataProcedureInternal(string commandText, string connectionName, InitialCatalog initialCatalog)
        {
            WriteLog(MethodInfo.GetCurrentMethod(), commandText, connectionName, initialCatalog);
            return base.CreateDataProcedureInternal(commandText, connectionName, initialCatalog);
        }
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod(), versionId, indexDocumentBytes);
        ...
        protected internal override IEnumerable<int> QueryNodesByTypeAndPath(int[] nodeTypeIds, string[] pathStart, bool orderByPath)
        {
            WriteLog(MethodInfo.GetCurrentMethod(), nodeTypeIds, "[\"" + String.Join("\", \"", pathStart) + "\"]", orderByPath);
            return base.QueryNodesByTypeAndPath(nodeTypeIds, pathStart, orderByPath);
        }
        ...
        protected internal override IEnumerable<int> QueryNodesByTypeAndPathAndName(int[] nodeTypeIds, string[] pathStart, bool orderByPath, string name)
        {
            WriteLog(MethodInfo.GetCurrentMethod(), nodeTypeIds, pathStart == null ? "[null]" : "[\"" + String.Join("\", \"", pathStart) + "\"]", orderByPath, name);
            return base.QueryNodesByTypeAndPathAndName(nodeTypeIds, pathStart, orderByPath, name);
        }
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod(), name, edition, version, description);
            return base.CreateInitialVersion(name, edition, version, description);
        }
        public override void DeletePackage(Package package)
        {
            WriteLog(MethodInfo.GetCurrentMethod(), package);
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod());
            return base.GetCurrentTransactionInternal();
        }
        protected internal override string GetPermissionLoaderScript()
        {
            WriteLog(MethodInfo.GetCurrentMethod());
            return base.GetPermissionLoaderScript();
        }
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod(), binaryPropertyId, clearStream);
            return base.LoadFileStreamData(binaryPropertyId, clearStream, versionId);
        }
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod());
            return base.LoadOfficialVersion();
        }
        public override DateTime RoundDateTime(DateTime d)
        {
            WriteLog(MethodInfo.GetCurrentMethod(), d);
            return base.RoundDateTime(d);
        }
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod(), versionId, propertyTypeId);
            return base.StartChunk(versionId, propertyTypeId);
        }
        ...
        {
            WriteLog(MethodInfo.GetCurrentMethod(), token, buffer, offset, fullSize);
