...
namespace ContentRepository.Tests.Schema
{
    ...
    public class SqlSchemaWriterTest : TestBase
	{
		...
		private class SqlSchemaWriterAccessor : Accessor
		{
			...
			{
				PrivateType pt = new PrivateType("Storage", "ContentRepository.Storage.Data.SqlClient.SqlSchemaWriter");
...
";
		...
		private Content CreateTestNodeForRemovePropertyType()
		{
			ContentTypeInstaller.InstallContentType(@"<?xml version='1.0' encoding='utf-8'?>
				<ContentType name='TestNodeForRemovePropertyType' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
					<Fields>
