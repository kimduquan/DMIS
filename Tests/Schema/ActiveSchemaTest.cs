...
namespace ContentRepository.Tests.Storage
{
	/// <summary>
	///This is a test class for ContentRepository.Storage.ActiveSchema and is intended
	///to contain all ContentRepository.Storage.ActiveSchema Unit Tests
	///</summary>
	[TestClass()]
