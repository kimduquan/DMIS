    ...
    public class ContentInstallTest2 : TestBase
	{
		...
		public void ContentType_Install_InheritedClass()
		{
			string contentTypeADef = @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='TestNode10' handler='ContentRepository.Tests.ContentHandlers.TestNode10' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
								<Fields>
			...
			string contentTypeBDef = @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='TestNode11' parentType='TestNode10' handler='ContentRepository.Tests.ContentHandlers.TestNode11' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
								<Fields>
			...
			string expectedLog = @"
				Open();
				CreatePropertyType(name=<Y>, dataType=<Int>, isContentListProperty=<False>);
				CreateNodeType(parent=<TestNode10>, name=<TestNode11>, className=<ContentRepository.Tests.ContentHandlers.TestNode11>);
		...
		public void ContentType_FullInstall_InheritedClass_ChangeHandlers()
		{
			...
			contentTypeADef = @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='TestNode10' handler='ContentRepository.Tests.ContentHandlers.TestNode12' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
								<Fields>
			...
			contentTypeBDef = @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='TestNode11' parentType='TestNode10' handler='ContentRepository.Tests.ContentHandlers.TestNode13' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
								<Fields>
									<!--
		...
		public void ContentType_FullInstall_InheritedClass_ChangeHandlers1()
		{
			...
			contentTypeADef = @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='TestNode10' handler='Unknown' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
								<Fields>
									<Field name='A' type='Integer'><DisplayName>A</DisplayName></Field>
									<Field name='B' type='Integer'><DisplayName>B</DisplayName></Field>
									<Field name='C' type='Integer'><DisplayName>C</DisplayName></Field>
		...
		public void ContentType_FullInstall_LongFlat()
		{
			...
			sb.Append("<ContentType name='").Append(typeName).Append("' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>\r\n");
		...
		public void ContentType_FullInstall_DataTypeCollision()
		{
			...
			string ctd1 = @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='DataTypeCollisionTestHandler' parentType='GenericContent' handler='ContentRepository.Tests.ContentHandlers.DataTypeCollisionTestHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
								<Fields>
		...
		public void ContentType_FullInstall_DataTypeCollision_Inherited()
		{
			...
			string ctd2 = @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='DataTypeCollisionTestHandler1' parentType='DataTypeCollisionTestHandler' handler='ContentRepository.Tests.ContentHandlers.DataTypeCollisionTestHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
								<Fields>
									<Field name='TestString' type='LongText'>
										<Bind property='TestString' />
									</Field>
