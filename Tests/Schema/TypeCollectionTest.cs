...
{
	/// <summary>
	///This is a test class for ContentRepository.Storage.Schema.TypeCollection&lt;T&gt; and is intended
	///to contain all ContentRepository.Storage.Schema.TypeCollection&lt;T&gt; Unit Tests
	///</summary>
	[TestClass()]
