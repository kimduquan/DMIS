...
namespace ContentRepository.Tests.Schema
{
    ...
    public class ContentInstallTest : TestBase
    {
        ...
        public void ContentType_IsDeletable()
        {
            ...
            installer.AddContentType(@"<?xml version='1.0' encoding='utf-8'?>
				<ContentType name='Automobile5' parentType='Automobile' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
					<Fields />
				</ContentType>");
            installer.AddContentType(@"<?xml version='1.0' encoding='utf-8'?>
				<ContentType name='Automobile6' parentType='Automobile5' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
					<Fields />
				</ContentType>");
        ...
        {
            //---- valid
            var ctd = @"<ContentType name=""Valid_ContentType_Name"" parentType=""GenericContent"" handler=""ContentRepository.GenericContent"" xmlns=""http://schemas.com/ContentRepository/ContentTypeDefinition"">
</ContentType>";
            ...
            //---- invalid
            ctd = @"<ContentType name=""Invalid.ContentType.Name"" parentType=""GenericContent"" handler=""ContentRepository.GenericContent"" xmlns=""http://schemas.com/ContentRepository/ContentTypeDefinition"">
</ContentType>";
    ...
    <Fields><Field name=""Valid_Field_Name"" type=""ShortText"" /></Fields>
            ...
            //---- invalid
            ctd = @"<ContentType name=""Valid_ContentType_Namee"" parentType=""GenericContent"" handler=""ContentRepository.GenericContent"" xmlns=""http://schemas.com/ContentRepository/ContentTypeDefinition"">
    <Fields><Field name=""Invalid.Field.Name"" type=""ShortText"" /></Fields>
        ...
        public void ContentList_FieldNameCannotContainsADot()
        {
            ...
            //---- valid
            string listTypeDef = @"<ContentListDefinition xmlns='http://schemas.com/ContentRepository/ContentListDefinition'>
...
";
            ...
            //---- invalid
            listTypeDef = @"<ContentType name=""Valid_ContentType_Namee"" parentType=""GenericContent"" handler=""ContentRepository.GenericContent"" xmlns=""http://schemas.com/ContentRepository/ContentTypeDefinition"">
    <Fields><Field name=""Invalid.Field.Name"" type=""ShortText"" /></Fields>
</ContentType>";
            bool exceptionIsThrown = false;
            bool validExceptionIsThrown = false;
        ...
        public void ContentType_ReInstall_RemoveFieldsAndInheritance()
        {
            ...
            installer.AddContentType(@"<?xml version='1.0' encoding='utf-8'?>
				<ContentType name='Automobile2' parentType='Automobile' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
					<Fields />
				</ContentType>");
            installer.AddContentType(@"<?xml version='1.0' encoding='utf-8'?>
				<ContentType name='Automobile3' parentType='Automobile2' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
					<Fields />
				</ContentType>");
            installer.ExecuteBatch(_installedContentTypes);
...
CreatePropertyType(name=<ApprovingMode>, dataType=<Int>, isContentListProperty=<False>);
CreatePropertyType(name=<InheritableApprovingMode>, dataType=<Int>, isContentListProperty=<False>);
CreatePropertyType(name=<AllowedChildTypes>, dataType=<Text>, isContentListProperty=<False>);
CreatePropertyType(name=<TrashDisabled>, dataType=<Int>, isContentListProperty=<False>);
CreatePropertyType(name=<EnableLifespan>, dataType=<Int>, isContentListProperty=<False>);
CreatePropertyType(name=<ValidFrom>, dataType=<DateTime>, isContentListProperty=<False>);
CreatePropertyType(name=<ValidTill>, dataType=<DateTime>, isContentListProperty=<False>);
CreatePropertyType(name=<Aspects>, dataType=<Reference>, isContentListProperty=<False>);
CreatePropertyType(name=<AspectData>, dataType=<Text>, isContentListProperty=<False>);
CreatePropertyType(name=<BrowseApplication>, dataType=<Reference>, isContentListProperty=<False>);
CreatePropertyType(name=<ExtensionData>, dataType=<Text>, isContentListProperty=<False>);
CreatePropertyType(name=<IsTaggable>, dataType=<Int>, isContentListProperty=<False>);
CreatePropertyType(name=<Tags>, dataType=<Text>, isContentListProperty=<False>);
CreatePropertyType(name=<IsRateable>, dataType=<Int>, isContentListProperty=<False>);
CreatePropertyType(name=<RateStr>, dataType=<String>, isContentListProperty=<False>);
CreatePropertyType(name=<RateAvg>, dataType=<Currency>, isContentListProperty=<False>);
CreatePropertyType(name=<RateCount>, dataType=<Int>, isContentListProperty=<False>);
CreatePropertyType(name=<CheckInComments>, dataType=<Text>, isContentListProperty=<False>);
CreatePropertyType(name=<RejectReason>, dataType=<Text>, isContentListProperty=<False>);
CreateNodeType(parent=<GenericContent>, name=<Automobile>, className=<ContentRepository.Tests.ContentHandlers.AutomobileHandler>);
...
AddPropertyTypeToPropertySet(propertyType=<Aspects>, owner=<Automobile>, isDeclared=<True>);
AddPropertyTypeToPropertySet(propertyType=<AspectData>, owner=<Automobile>, isDeclared=<True>);
...
AddPropertyTypeToPropertySet(propertyType=<RejectReason>, owner=<Automobile>, isDeclared=<True>);
Close();";
            string log = InstallContentType(contentTypeDef, null);
            //log = log.Replace("\r", "").Replace("\n", "").Replace("\t", "").Replace(" ", "");
            ContentTypeManager.Reset();

            var expectedLines = expected.Split(';').Select(s => s.Trim()).ToArray();
            var logLines = log.Split(';').Select(s => s.Trim()).ToArray();

            var x = string.Join(" | ", expectedLines.Except(logLines));
            var y = string.Join(" | ",  logLines.Except(expectedLines));
...
<ContentType name='Automobile' parentType='GenericContent' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
	...
	<Fields>
		<Field name='Manufacturer' type='ShortText' handler='ContentRepository.Fields.ShortTextField'>
...
";
        ...
        {
            ContentTypeInstaller.InstallContentType(@"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='Automobile' parentType='GenericContent' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
							...
							<ContentType name='Automobile1' parentType='Automobile' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <Fields>
									<Field name='Manufacturer' type='ShortText' />
									<Field name='Driver' type='ShortText'>
                                        <AppInfo>Field &lt;y&gt;AppInfo&lt;/y&gt; test</AppInfo>
            ...
            Assert.IsTrue(appInfo0 == "ContentType AppInfo test");
            Assert.IsTrue(appInfo1 == "Field <y>AppInfo</y> test");
            Assert.IsTrue(appInfo2 == "Field AppInfo test");
            ...
            Assert.IsTrue(appInfo1 == "Field <y>AppInfo</y> test");
            Assert.IsTrue(appInfo2 == "Field AppInfo test");
            Assert.IsTrue(appInfo3 == "Field <y>AppInfo</y> test");
        }
        ...
        {
            ContentTypeInstaller.InstallContentType(@"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ContentList_for_AllowChildTypes' parentType='ContentList' handler='ContentRepository.ContentList' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <Fields />
							</ContentType>",
                            @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='Automobile' parentType='GenericContent' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
        ...
        public void Check_ChildTypesToAllow()
        {
            ...
            ContentTypeInstaller.InstallContentType(@"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ChildTypesToAllow_A' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <Fields />
							</ContentType>",

                            @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ChildTypesToAllow_B' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <Fields />
							</ContentType>",

                            @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ChildTypesToAllow_C' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <Fields />
							</ContentType>",

                            @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ChildTypesToAllow_D' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <Fields />
							</ContentType>",

                            @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ChildTypesToAllow_X' parentType='GenericContent' handler='ContentRepository.Folder' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <AllowedChildTypes>ChildTypesToAllow_A ChildTypesToAllow_B ChildTypesToAllow_C ChildTypesToAllow_D</AllowedChildTypes>
                                <Fields />
							</ContentType>",

                            @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ChildTypesToAllow_Y' parentType='GenericContent' handler='ContentRepository.Folder' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <AllowedChildTypes>ChildTypesToAllow_A ChildTypesToAllow_B ChildTypesToAllow_C ChildTypesToAllow_D</AllowedChildTypes>
                                <Fields />
							</ContentType>",

                            @"<?xml version='1.0' encoding='utf-8'?>
							<ContentType name='ChildTypesToAllow_Z' parentType='GenericContent' handler='ContentRepository.Folder' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' xmlns:x='xx'>
                                <AllowedChildTypes>ChildTypesToAllow_A ChildTypesToAllow_B ChildTypesToAllow_C ChildTypesToAllow_D</AllowedChildTypes>
                                <Fields />
							</ContentType>"
                            );
        ...
        public void ContentType_Bug5093()
        {
            ...
            ContentTypeInstaller.InstallContentType(@"<ContentType
                    name='Automobile' parentType='GenericContent' handler='ContentRepository.Tests.ContentHandlers.AutomobileHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
                <Fields>
                    <Field name='Name' type='ShortText' />
	                <Field name='Manufacturer' type='ShortText' />
                </Fields>
        ...
        public void ContentType_Bug5564()
        {
            ContentTypeInstaller.InstallContentType(
                @"<ContentType name='CTBug5564_A' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
                    <Fields>
                        <Field name='abcde' type='ShortText' />
                    </Fields>
                </ContentType>",
                @"<ContentType name='CTBug5564_B' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
                    <Fields>
        ...
        public void ContentType_Bug572_UnknownAnalyzer()
        {
            ...
            var ctdsrc = @"<ContentType
                name='ContentType_Bug572_UnknownAnalyzer' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
                <Fields>
        ...
        public void ContentType_Bug574_DeletingDynamicProperty()
        {
            ...
            //       The conflict occurred in database "ContentRepository", table "dbo.TextPropertiesNVarchar", column 'PropertyTypeId'. 
...
<ContentType name='Contract' parentType='File' handler='ContentRepository.File' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
    <DisplayName>Contract</DisplayName>
	<Description>An example content type to demonstrate the ECMS features of 6.0.</Description>
	<Icon>Document</Icon>
	<Fields>
...
<StorageSchema xmlns='http://schemas.com/ContentRepository/Storage/Schema'>
	<UsedPropertyTypes>
	...
	<NodeTypeHierarchy>
		<NodeType itemID='7' name='PersonalizationFile' className='ContentRepository.PersonalizationFile'>
		...
		<NodeType itemID='5' name='GenericContent' className='ContentRepository.GenericContent'>
			<PropertyType name='VersioningMode' />
			<PropertyType name='InheritableVersioningMode' />
			<PropertyType name='HasApproving' />
			<NodeType itemID='3' name='User' className='ContentRepository.User'>
				<PropertyType name='VersioningMode' />
			...
			<NodeType itemID='1' name='Folder' className='ContentRepository.Folder'>
				<PropertyType name='VersioningMode' />
				<NodeType itemID='16' name='Page' className='Portal.Page'>
					<PropertyType name='Binary' />
				...
				<NodeType itemID='15' name='OrganizationalUnit' className='ContentRepository.OrganizationalUnit'>
				</NodeType>
				<NodeType itemID='14' name='Site' className='Portal.Site'>
			...
			<NodeType itemID='10' name='WebContentDemo' className='ContentRepository.GenericContent'>
				<PropertyType name='Keywords' />
			...
			<NodeType itemID='9' name='File' className='ContentRepository.File'>
				<PropertyType name='Binary' />
				<NodeType itemID='13' name='PageTemplate' className='Portal.PageTemplate'>
					<PropertyType name='MasterPageNode' />
				</NodeType>
				<NodeType itemID='12' name='Contract' className='ContentRepository.File'>
					<PropertyType name='Description' />
					<PropertyType name='Language' />
					<PropertyType name='Keywords' />
				...
				<NodeType itemID='11' name='MasterPage' className='Portal.MasterPage' />
			</NodeType>
			<NodeType itemID='8' name='Car' className='ContentRepository.GenericContent'>
		...
		<NodeType itemID='4' name='ContentType' className='ContentRepository.Schema.ContentType'>
			<PropertyType name='Binary' />
		</NodeType>
		<NodeType itemID='2' name='Group' className='ContentRepository.Group'>
			<PropertyType name='VersioningMode' />
...
");
        ...
        {
            var ns = "http://schemas" + ".hu/ContentRepository/ContentTypeDefinition";
        ...
        {
            var ns = "http://schemas.com/ContentRepository/ContentTypeDefinition";
        ...
        private string CheckContentTypeXmlNamespaceCompatibility(string xmlNamespace, string namespaceName, bool featureEnabled)
        {
            ...
            string contentTypeDef = String.Format(@"<ContentType name='{0}' parentType='GenericContent' 
                        handler='ContentRepository.GenericContent' xmlns='{1}'>
        ...
        [TestMethod]
        public void ContentType_Reinstall_InvalidateCache()
        {
            //===== 0. Preparing test
            var newFieldName = "x" + Guid.NewGuid().ToString("N");
            string origCtd;
            using (var reader = new System.IO.StreamReader(ContentType.GetByName("Car").Binary.GetStream()))
                origCtd = reader.ReadToEnd();
            var extendedCtd = origCtd.Insert(origCtd.IndexOf("<Fields>") + "<Fields>".Length, string.Format("<Field name='{0}' type='ShortText'></Field>", newFieldName));

            try
            {
                //===== 1. Creating a cached instance
                var content1 = Content.CreateNew("Car", _testRoot, null);
                content1.Save();
                var id = content1.Id;
                var versionId = content1.ContentHandler.VersionId;
                var propCount1 = content1.ContentHandler.PropertyTypes.Count;
                var idKey = DataBackingStore.GenerateNodeDataVersionIdCacheKey(versionId);
                Assert.IsNotNull(DistributedApplication.Cache.Get(idKey), "A folder's NodeData is not cached after creation");

                //===== 2. Extending "Car" ctd with a new field
                ContentTypeInstaller.InstallContentType(extendedCtd);
                Assert.IsNull(DistributedApplication.Cache.Get(idKey), "A folder's NodeData is cached after extending CTD");

                //===== 3. Property set count doesn't changed
                var propCount2 = content1.ContentHandler.PropertyTypes.Count;
                Assert.IsTrue(propCount2 == propCount1, "#1");

                //===== 4. Property set must be extended on the new node
                var content2 = Content.CreateNew("Car", _testRoot, null);
                var propCount3 = content2.ContentHandler.PropertyTypes.Count;
                Assert.IsTrue(propCount3 == propCount1 + 1, "#3");
                Assert.IsTrue(content2.ContentHandler.PropertyTypes[newFieldName] != null, "#4");

                //===== 5. Property set must be extended on the reloaded node
                var content3 = Content.Load(id);
                var propCount4 = content3.ContentHandler.PropertyTypes.Count;
                Assert.IsTrue(propCount4 == propCount1 + 1, "#5");
                Assert.IsTrue(content3.ContentHandler.PropertyTypes[newFieldName] != null, "#6");
            }
            finally
            {
                //===== Cleaning
                ContentTypeInstaller.InstallContentType(origCtd);
            }
        }
