...
namespace ContentRepository.Tests
{
    ...
    public class RuntimeContentTest : TestBase
    {
        ...
        {
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(bool)) == typeof(ContentRepository.Fields.BooleanField), "bool -> BooleanField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(int)) == typeof(ContentRepository.Fields.IntegerField), "int -> IntegerField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(string)) == typeof(ContentRepository.Fields.ShortTextField), "string -> ShortTextField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(DateTime)) == typeof(ContentRepository.Fields.DateTimeField), "DateTime -> DateTimeField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(decimal)) == typeof(ContentRepository.Fields.NumberField), "decimal -> NumberField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(double)) == typeof(ContentRepository.Fields.NumberField), "double -> NumberField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(VersionNumber)) == typeof(ContentRepository.Fields.VersionField), "VersionNumber -> VersionField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(BinaryData)) == typeof(ContentRepository.Fields.BinaryField), "BinaryData -> BinaryField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(Node)) == typeof(ContentRepository.Fields.ReferenceField), "Node -> ReferenceField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(User)) == typeof(ContentRepository.Fields.ReferenceField), "User -> ReferenceField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(IEnumerable<Node>)) == typeof(ContentRepository.Fields.ReferenceField), "IEnumerable<Node> -> ReferenceField");
            Assert.IsTrue(DynamicContentTools.GetSuggestedFieldType(typeof(IEnumerable<User>)) == typeof(ContentRepository.Fields.ReferenceField), "IEnumerable<User> -> ReferenceField");
        ...
        {
            var ctd = @"<ContentType name=""RuntimeNode"" parentType=""GenericContent"" handler=""ContentRepository.GenericContent"" xmlns=""http://schemas.com/ContentRepository/ContentTypeDefinition"">
...
";
        ...
        {
            ContentTypeInstaller.InstallContentType(@"<ContentType name='Class2' parentType='GenericContent' handler='ContentRepository.GenericContent' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'><Fields /></ContentType>");

            //-- Checks the contettype and indexing subsystem usability. Do not remove!
            var x = Search.ContentQuery.Query("Name:*admin* .SORT:Id .TOP:100");
        ...
        public class Class3
        {
            ...
            public DateTime ReadonlyDateTimeProperty { get { return DateTime.UtcNow; } }
        }
    }
}
