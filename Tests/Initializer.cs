...
namespace ContentRepository.Tests
{
	...
	public class Initializer
	{
        ...
        public static void InitializeAllTests(TestContext context)
        {
            ...
            var populator = new Search.Indexing.DocumentPopulator();
            populator.ClearAndPopulateAll();
            repo.StartLucene();

            SetRootPermissions();

            ContentTypeInstaller.InstallContentType(ContentRepository.Tests.ContentHandlers.TestSystemFolder.ContentTypeDefinition);
