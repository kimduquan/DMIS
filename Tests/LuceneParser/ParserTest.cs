...
namespace ContentRepository.Tests.LuceneParser
{
    ...
    public class ParserTest : TestBase
    {
        ...
        public void Parser_Keywords_1()
        {
            ...
            msg = CheckQueryObject(src, "Name:xy .COUNTONLY .LIFESPAN:ON", "Name:xy", FilterStatus.Default, FilterStatus.Enabled, null, null, true);
            Assert.IsNull(msg, "#1: " + msg);

            src = "Name:xy .COUNTONLY .LIFESPAN:ON";
            msg = CheckQueryObject(src, src, "Name:xy", FilterStatus.Default, FilterStatus.Enabled, null, null, true);
            Assert.IsNull(msg, "#2: " + msg);

            src = "Name:xy .AUTOFILTERS:OFF";
            msg = CheckQueryObject(src, src, "Name:xy", FilterStatus.Disabled, FilterStatus.Default, null, null, false);
            Assert.IsNull(msg, "#3: " + msg);

            src = "Name:xy .AUTOFILTERS:ON";
            msg = CheckQueryObject(src, "Name:xy", "Name:xy", FilterStatus.Enabled, FilterStatus.Default, null, null, null);
            Assert.IsNull(msg, "#4: " + msg);

            src = "Name:xy .LIFESPAN:ON";
            msg = CheckQueryObject(src, src, "Name:xy", FilterStatus.Default, FilterStatus.Enabled, null, null, null);
            Assert.IsNull(msg, "#5: " + msg);

            src = "Name:xy .LIFESPAN:OFF";
            msg = CheckQueryObject(src, "Name:xy", "Name:xy", FilterStatus.Default, FilterStatus.Disabled, null, null, null);
            Assert.IsNull(msg, "#6: " + msg);

            src = "Name:xy .AUTOFILTERS:OFF .LIFESPAN:ON";
            msg = CheckQueryObject(src, src, "Name:xy", FilterStatus.Disabled, FilterStatus.Enabled, null, null, null);
            Assert.IsNull(msg, "#7: " + msg);
            ...
            msg = CheckQueryObject(src, @out, "Name:xy DisplayName:title", FilterStatus.Default, FilterStatus.Default, 10, 20, null, "+Field1", "-Field2", "+Field3");
            Assert.IsNull(msg, "#8: " + msg);
        }
        ...
        //======================================================================================== Empty term query
        [TestMethod]
        public void Parser_EmptryTerm()
        {
            Query q1 = null;
            Query q2 = null;
            try
            {
                q1 = ParseLucQuery(string.Empty);
            }
            catch { }
            try
            {
                q2 = ParseNewQuery(string.Empty);
            }
            catch { }

            CompareQueries(q1, q2);
        ...
        {
            var dummy = ContentRepository.Schema.ContentType.GetByName("ContentType");
