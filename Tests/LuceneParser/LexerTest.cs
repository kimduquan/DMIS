...
namespace ContentRepository.Tests.LuceneParser
{
    [TestClass]
...
").ToArray();
            ...
            t = tokens[0]; Assert.AreEqual(SnLucLexer.Token.Plus, t.Token); Assert.AreEqual("+", t.Value);
            t = tokens[1]; Assert.AreEqual(SnLucLexer.Token.Field, t.Token); Assert.AreEqual("Id", t.Value);
            t = tokens[2]; Assert.AreEqual(SnLucLexer.Token.Colon, t.Token); Assert.AreEqual(":", t.Value);
            t = tokens[3]; Assert.AreEqual(SnLucLexer.Token.GT, t.Token); Assert.AreEqual(">", t.Value);
            t = tokens[4]; Assert.AreEqual(SnLucLexer.Token.Number, t.Token); Assert.AreEqual("042", t.Value);
            t = tokens[5]; Assert.AreEqual(SnLucLexer.Token.Plus, t.Token); Assert.AreEqual("+", t.Value);
            t = tokens[6]; Assert.AreEqual(SnLucLexer.Token.Field, t.Token); Assert.AreEqual("TypeIs", t.Value);
            t = tokens[7]; Assert.AreEqual(SnLucLexer.Token.Colon, t.Token); Assert.AreEqual(":", t.Value);
            t = tokens[8]; Assert.AreEqual(SnLucLexer.Token.String, t.Token); Assert.AreEqual("WebContent", t.Value);
            t = tokens[9]; Assert.AreEqual(SnLucLexer.Token.Minus, t.Token); Assert.AreEqual("-", t.Value);
            t = tokens[10]; Assert.AreEqual(SnLucLexer.Token.Field, t.Token); Assert.AreEqual("Name", t.Value);
            t = tokens[11]; Assert.AreEqual(SnLucLexer.Token.Colon, t.Token); Assert.AreEqual(":", t.Value);
            t = tokens[12]; Assert.AreEqual(SnLucLexer.Token.WildcardString, t.Token); Assert.AreEqual("// /* this is not a comment */", t.Value);
            t = tokens[13]; Assert.AreEqual(SnLucLexer.Token.ControlKeyword, t.Token); Assert.AreEqual(".TOP", t.Value);
            t = tokens[14]; Assert.AreEqual(SnLucLexer.Token.Colon, t.Token); Assert.AreEqual(":", t.Value);
            t = tokens[15]; Assert.AreEqual(SnLucLexer.Token.Number, t.Token); Assert.AreEqual("3", t.Value);
...
").ToArray();
            ...
            t = tokens[7]; Assert.AreEqual(SnLucLexer.Token.Colon, t.Token); Assert.AreEqual(":", t.Value);
            t = tokens[8]; Assert.AreEqual(SnLucLexer.Token.String, t.Token); Assert.AreEqual("WebContent", t.Value);
            t = tokens[9]; Assert.AreEqual(SnLucLexer.Token.String, t.Token); Assert.AreEqual("/unparsed", t.Value);
            t = tokens[10]; Assert.AreEqual(SnLucLexer.Token.String, t.Token); Assert.AreEqual("comment", t.Value);
        }
