...
{
    /// <summary>
    ///This is a test class for Portal.Virtualization.PortalContext and is intended
    ///to contain all Portal.Virtualization.PortalContext Unit Tests
    ///</summary>
    [TestClass()]
    public class PortalContextTest : TestBase
    {
        ...
        {
            var node = ContentRepository.Storage.Node.LoadNode("/Root/Fake Test Site");
            if (node != null)
                node.ForceDelete();
        }
