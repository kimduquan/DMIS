...
<ContentType name='RepositoryTest_RefTestNode' parentType='GenericContent' handler='ContentRepository.Tests.ContentHandlers.RefTestNode' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
	<Fields>
