...
namespace ContentRepository.Tests.ContentHandlers
{
    ...
    {
        public static string ContentTypeDefinition = @"<?xml version='1.0' encoding='utf-8'?><ContentType name='TestSystemFolder' parentType='SystemFolder' handler='ContentRepository.Tests.ContentHandlers.TestSystemFolder' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition' />";
