...
namespace ContentRepository.Tests.ContentHandler
{
	[TestClass()]
    public class ContentTest : TestBase
	{
		...
		//    __typeInfo(typeof(ContentRepository.File), sb);
		//    __typeInfo(typeof(ContentRepository.Folder), sb);
		//    __typeInfo(typeof(Portal.Page), sb);
		//    __typeInfo(typeof(Portal.Site), sb);
		//    __typeInfo(typeof(ContentRepository.OrganizationalUnit), sb);
		//    __typeInfo(typeof(ContentRepository.User), sb);
		//    __typeInfo(typeof(ContentRepository.Group), sb);
		//    __typeInfo(typeof(Portal.PageTemplate), sb);

		//    Assert.Inconclusive();
		//}
		//private void __typeInfo(Type type, StringBuilder sb)
		//{
		//    //<ContentType name="___" handler="___" xmlns="http://schemas.com/ContentRepository/ContentTypeDefinition">\r\n
		//    sb.Append("<ContentType name=\"");
		//    sb.Append(type.Name);
		//    sb.Append("\" handler=\"");
		//    sb.Append(type.FullName);
		//    sb.Append("\" xmlns=\"http://schemas.com/ContentRepository/ContentTypeDefinition\">\r\n");
		...
		//            {
		//                case "ContentRepository.Group": fieldType = "ReferenceField"; break;
		//                case "Portal.MasterPage": fieldType = "ReferenceField"; break;
		//                case "Portal.Page": fieldType = "ReferenceField"; break;
		//                case "Portal.PageTemplate": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.Storage.BinaryData": fieldType = "BinaryField"; break;
		//                case "ContentRepository.Storage.Node": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.Storage.NodeList`1[[ContentRepository.Storage.Node]]": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.Storage.NodeList`1[[ContentRepository.Storage.Security.Group]]": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.Storage.NodeList`1[[ContentRepository.Storage.Security.User]]": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.Storage.Schema.NodeType": fieldType = "NodeTypeField"; break;
		//                case "ContentRepository.Storage.Security.Group": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.Storage.Security.LockHandler": fieldType = "LockField"; break;
		//                case "ContentRepository.Storage.Security.SecurityHandler": fieldType = "SecurityField"; break;
		//                case "ContentRepository.Storage.Security.User": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.Storage.VersionNumber": fieldType = "VersionField"; break;
		//                case "Portal.Site": fieldType = "ReferenceField"; break;
		//                case "ContentRepository.User": fieldType = "ReferenceField"; break;
...
");
	...
	public class GenericControl : Control, Portal.UI.IFieldControl
	{
		public Label label1;
	...
	public class ColorEditorControl : Control, Portal.UI.IFieldControl
	{
