...
using ContentRepository.Tests.Schema;
using System.Text;
using Diagnostics;
...
";
        ...
        {
            var ns = "http://schemas" + ".hu/ContentRepository/Lis" + "terTypeDefinition";
        ...
        {
            var ns = "http://schemas.com/ContentRepository/ContentListDefinition";
