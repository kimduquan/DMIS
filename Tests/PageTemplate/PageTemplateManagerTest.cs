...
namespace ContentRepository.Tests
{
    ...
    public class PageTemplateManagerTest : TestBase
	{
		...
		public void PageTemplateManager_CheckPageTemplateBinaryStream_Test()
		{
			...
			bool expected = true;
			bool actual = ContentRepository.Tests.Portal_PageTemplateManagerAccessor.CheckPageTemplateBinaryStream(pageTemplate);
		...
		public void PageTemplateManager_GetFileNameExtension_Test()
		{
			...
			string expected = "doc";
			string actual = ContentRepository.Tests.Portal_PageTemplateManagerAccessor.GetFileNameExtension(fileName);
		...
		{
			object target = ContentRepository.Tests.Portal_PageTemplateManagerAccessor.CreatePrivate();
			ContentRepository.Tests.Portal_PageTemplateManagerAccessor accessor = new ContentRepository.Tests.Portal_PageTemplateManagerAccessor(target);
		...
		public void PageTemplateManager_GetFileNameWithoutExt_StaticTest()
		{
			...
			string expected = "word";
			string actual = ContentRepository.Tests.Portal_PageTemplateManagerAccessor.GetFileNameWithoutExt(fileName);
