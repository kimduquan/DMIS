...
{
	/// <summary>
	///This is a test class for ContentRepository.GenericContent and is intended
	///to contain all ContentRepository.GenericContent Unit Tests
	///</summary>
	[TestClass()]
    public class GenericContentTest : TestBase
	{
        ...
        public void x()
        {
            ...
            var bh = (System.Web.IHttpHandler)(new Portal.Handlers.BinaryHandler());
            ...
            bh = (System.Web.IHttpHandler)(new Portal.Handlers.BinaryHandler());
            bh.ProcessRequest(hctx);
