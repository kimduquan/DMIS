...
{
	/// <summary>
	///This is a test class for Portal.UrlNameValidator and is intended
	///to contain all Portal.UrlNameValidator Unit Tests
	///</summary>
	[TestClass()]
    public class UrlNameValidatorTest : TestBase
	{
		...
		public void ValidUrlNameTest()
		{
			...
			string actual = ContentRepository.Tests.Portal_UrlNameValidatorAccessor.ValidUrlName(urlName);
		...
		public void ValidateTest()
		{
			...
			bool expected = false;
			bool actual = ContentRepository.Tests.Portal_UrlNameValidatorAccessor.Validate(url);
