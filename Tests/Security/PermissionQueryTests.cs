    ...
    public class PermissionQueryTests : TestBase
    {
        ...
        private void CreatePlayground()
        {
            ...
            n = CreateNode("R");
            {
                ...
                n = CreateNode("RB"); Allow(n, "U1", "P1");
                {
                    n = CreateNode("RBA");
                    {
                        n = CreateNode("RBAA"); Break(n); Allow(n, "U2", "P1");
                        n = CreateNode("RBAB"); Break(n); Allow(n, "U2", "P1"); Clear(n, "U1", "P1");
                        n = CreateNode("RBAC"); Break(n);                       Clear(n, "U1", "P1");
                        n = CreateNode("RBAD"); Break(n);
                    }
                }
            }
        }
