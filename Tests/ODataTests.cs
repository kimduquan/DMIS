...
<ContentType name='OData_Filter_ThroughReference_ContentHandler' parentType='GenericContent' handler='ContentRepository.Tests.OData_Filter_ThroughReference_ContentHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
  <Fields>
...
";
    ...
    {
        public const string CTD = @"<?xml version='1.0' encoding='utf-8'?>
<ContentType name='OData_ReferenceTest_ContentHandler' parentType='GenericContent' handler='ContentRepository.Tests.OData_ReferenceTest_ContentHandler' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
  <Fields>
        ...
        internal class TestActionResolver : IActionResolver
        {
            ...
            public ActionBase GetAction(Content context, string scenario, string actionName, string backUri, object parameters)
            {
                switch (actionName)
                {
                    ...
                    case "SetPermissions": return new Portal.ApplicationModel.SetPermissionsAction();
                    case "HasPermission": return new Portal.ApplicationModel.HasPermissionAction();
                    case "AddAspects": return new ApplicationModel.AspectActions.AddAspectsAction();
                    case "RemoveAspects": return new ApplicationModel.AspectActions.RemoveAspectsAction();
                    case "RemoveAllAspects": return new ApplicationModel.AspectActions.RemoveAllAspectsAction();
                    case "AddFields": return new ApplicationModel.AspectActions.AddFieldsAction();
                    case "RemoveFields": return new ApplicationModel.AspectActions.RemoveFieldsAction();
                    case "RemoveAllFields": return new ApplicationModel.AspectActions.RemoveAllFieldsAction();
  ...
  ""Index"": 42
        ...
        public void OData_Post_References()
        {
            ...
            try
            {
                ...
                var json1 = string.Concat(@"models=[{""__ContentType"":""OData_ReferenceTest_ContentHandler"",""Name"":""", name1, @""",""Reference"":", pathRefs, @",""References"":", pathRefs, @",""Reference2"":""", simpleRefNode.Path, @"""}]");
                ...
                var json2 = string.Concat(@"models=[{""__ContentType"":""OData_ReferenceTest_ContentHandler"",""Name"":""", name2, @""",""Reference"":", idRefs, @",""References"":", idRefs, @",""Reference2"":", simpleRefNode.Id, @"}]");
        ...
        public void OData_NameEncoding_CreateAndRename()
        {
            ...
            var name = "*_|" + guid;
            var encodedName = ContentNamingHelper.GetNameFromDisplayName(name);
            var newName = ContentNamingHelper.GetNameFromDisplayName("___" + guid);
            try
            {
                // creating
...
";
        ...
        public void OData_Filter_NamespaceAndMemberChain()
        {
            ...
            try
            {
                ...
                using (var output = new System.IO.StringWriter())
                {
                    var pc = CreatePortalContext("/OData.svc/Root/IMS/BuiltIn/Portal", "$filter=ContentRepository.Tests.ODataFilterTestHelper/TestValue eq Name", output);
                    var handler = new ODataHandler();
                    handler.ProcessRequest(pc.OwnerHttpContext);
                    entities = GetEntities(output);
                }
        ...
        public void OData_Filter_AspectField()
        {
            ...
            aspect.AddFields(new FieldInfo
            {
                ...
                {
                    IndexHandler = "Search.Indexing.LowerStringIndexHandler"
                }
            });
        ...
        public void OData_InvokeDictionaryHandlerFunction()
        {
            ...
            try
            {
                ...
                using (var output = new System.IO.StringWriter())
                {
                    var pc = CreatePortalContext("/OData.svc/Root/System/Schema/ContentTypes/GenericContent('FieldSettingContent')/ODataGetParentChainAction"
