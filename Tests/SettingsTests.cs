...
namespace ContentRepository.Tests
{
    ...
    {
        public const string CTD = @"<ContentType name='NotLoadableAspect' parentType='Aspect' handler='ContentRepository.Tests.NotLoadableAspect' xmlns='http://schemas.com/ContentRepository/ContentTypeDefinition'>
</ContentType>";
