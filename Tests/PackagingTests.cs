    ...
    public class PackagingTests : TestBase
    {
        ...
        private void EnsureApplicationPackage(string name, Guid appId, string edition, PackageLevel packageLevel, Version version, ExecutionResult executionResult)
        {
            ...
            DataProvider.Current.SavePackage(new Package
            {
                ...
                Version = RepositoryVersionInfo.Instance.OfficialVersion.Version
            });
            RepositoryVersionInfo.Reset();
        }
        ...
        public void Packaging_InvalidRoot()
        {
            ...
            try
            {
                manifestAcc.InvokeStatic("Parse", xml, 0, true);
                Assert.Fail("InvalidPackageException was not thrown.");
            }
            catch (InvalidPackageException e)
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.WrongRootName, e.Message);
            }
        }
        ...
        public void Packaging_MissingLevel()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.MissingLevel, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_InvalidLevel()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.InvalidLevel, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_MissingType()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.MissingType, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_InvalidType()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.InvalidType, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_MissingName()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.MissingName, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_InvalidName()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.InvalidName, e.Message);
            }
        }
        ...
        public void Packaging_InvalidEdition()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.InvalidEdition, e.Message);
            }
        }
        [TestMethod]
        ...
        public void Packaging_EditionMismatch_InstalledNull()
        {
            ...
            {
                Assert.AreEqual(String.Format(Packaging.SR.Errors.Precondition.EditionMismatch_2, "[empty]", edition), e.Message);
            }
        }
        [TestMethod]
        public void Packaging_EditionMismatch_InstalledNotNull()
        {
            ...
            {
                Assert.AreEqual(String.Format(Packaging.SR.Errors.Precondition.EditionMismatch_2, edition, "Demo"), e.Message);
            }
        }
        ...
        public void Packaging_App_Patch_MissingReleaseDate()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.MissingReleaseDate, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_App_Patch_InvalidReleaseDate()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.InvalidReleaseDate, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_App_Patch_MissingAppId()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.MissingAppId, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_App_Patch_InvalidAppId()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.InvalidAppId, e.Message);
            }
        }
        [TestMethod]
        ...
        public void Packaging_CannotInstallInstalled()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Precondition.CannotInstallExistingApp, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_CannotUpgradeNotInstalled()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Precondition.AppIdDoesNotMatch, e.Message);
            }
        }
        ...
        public void Packaging_App_CannotUpgradeDifferentEdition()
        {
            ...
            {
                Assert.AreEqual(String.Format(Packaging.SR.Errors.Precondition.EditionMismatch_2, "Demo", "Enterprise"), e.Message);
            }
        }
        ...
        public void Packaging_App_Versioning_UnexpectedTarget()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.UnexpectedTarget, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_App_Versioning_TargetTooSmall()
        {
            ...
            {
                // Packaging.PackagePreconditionException: Invalid manifest: the target version (1.1) must be greater than the current application version (2.0).
                Assert.AreEqual(String.Format(Packaging.SR.Errors.Precondition.TargetVersionTooSmall_3, "application", "1.1", "1.1"), e.Message);
            }
        }
        [TestMethod]
        public void Packaging_App_Versioning_UnexpectedExpected()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.UnexpectedExpectedVersion, e.Message);
            }
        }
        ...
        public void Packaging_App_Versioning_ExpectedMinTooBig()
        {
            ...
            {
                Assert.AreEqual(String.Format(Packaging.SR.Errors.Precondition.MinimumVersion_1, "application"), e.Message);
            }
        }
        [TestMethod]
        public void Packaging_App_Versioning_ExpectedMaxTooSmall()
        {
            ...
            {
                Assert.AreEqual(String.Format(Packaging.SR.Errors.Precondition.MaximumVersion_1, "application"), e.Message);
            }
        }
        ...
        {
            var verInfo = RepositoryVersionInfo.Instance.OfficialVersion;
            var xml = new XmlDocument();
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.MissingEdition, e.Message);
            }
        }
        [TestMethod]
        public void Packaging_Prod_UnexpectedAppId()
        {
            ...
            {
                Assert.AreEqual(Packaging.SR.Errors.Manifest.UnexpectedAppId, e.Message);
            }
        }
        [TestMethod]
        ...
        {
            Debug.WriteLine("@#$Test> Product version: " + RepositoryVersionInfo.Instance.OfficialVersion.Version); 
            var xml = new XmlDocument();
            xml.LoadXml(@"<Package type='Product' level='Patch'>
                            <Name>TestTool</Name>
        ...
        public void Packaging_App_ValidFlow()
        {
			...
			{
                var executionContext = new ExecutionContext("packagePath", "targetPath", new string[0], "sandboxPath", manifest, phase, manifest.CountOfPhases, null, console);
        ...
        public void Packaging_Step_ResolveNetworkTargets()
        {
            ...
            var ctx = new ExecutionContext(@"C:\SnWeb_admin", @"C:\SnWeb", new[] { @"\\Server1\SnWeb", @"\\Server2\SnWeb" }, @"C:\SnWeb_admin\run", null, 0, 1, null, null);
        ...
        public void Packaging_App_UnfinishedResultOnFaulty()
        {
            ...
            {
                var manifest = (Manifest)manifestAcc.InvokeStatic("Parse", xml, phase, true);
                var executionContext = new ExecutionContext("packagePath", "targetPath", new string[0], "sandboxPath", manifest, phase, manifest.CountOfPhases, null, console);
                var pkgManAcc = new PrivateType(typeof(PackageManager));
                try
                {
        ...
        public void Packaging_Prod_Executing2ndIfLastIsWrong()
        {
            ...
            var verInfo = RepositoryVersionInfo.Instance; // must refresh
            Assert.AreEqual(Version.Parse("6.6"), verInfo.OfficialVersion.Version);
            ...
            verInfo = RepositoryVersionInfo.Instance; // must refresh
            var appInfo = verInfo.OfficialVersion;
            ...
            var actual = String.Join(", ", verInfo.InstalledPackages
                ...
                .OrderBy(p => p.Version)
                .Select(p => String.Format("{0}: {1}", p.Version, p.ExecutionResult)));
        ...
        [TestMethod]
        public void PackagingStep_ContentType_AddField_DefaultPropertyWithCData()
        {
            var contentTypeName = "PackagingStep_ContentType_AddField";

            ContentTypeInstaller.InstallContentType(String.Format(@"<ContentType name=""{0}"" parentType=""GenericContent"" handler=""ContentRepository.GenericContent"" xmlns=""http://schemas.com/ContentRepository/ContentTypeDefinition"">
                    <Fields>
                        <Field name=""abcd"" type=""ShortText""></Field>
                        <Field name=""efgh"" type=""Integer""></Field>
                    </Fields>
            ...
            var xml = new XmlDocument();
            xml.LoadXml(@"<Package type='Product' level='Tool'>
                            <Name>PackagingStep_ContentType_AddField</Name>
                            <ReleaseDate>2014-04-01</ReleaseDate>
                            <Steps>
                              <AddField contentType='" + contentTypeName + @"'>
                                <![CDATA[
            ...
            try
            {
                ...
                {
                    var executionContext = new ExecutionContext("packagePath", "targetPath", new string[0], "sandboxPath", manifest, phase, manifest.CountOfPhases, null, console);
                    var executionContextAcc = new PrivateObject(executionContext);
                    executionContextAcc.SetProperty("RepositoryStarted", true);
                ...
                Assert.IsNotNull(ContentType.GetByName(contentTypeName).FieldSettings.FirstOrDefault(f => f.Name == "OurNewField"));
            }
            finally
            {
        ...
        [TestMethod]
        public void PackagingStep_ContentType_AddField_ExplicitPropertyWithoutCData()
        {
            var contentTypeName = "PackagingStep_ContentType_AddField";
            ...
            try
            {
                ...
                ContentType.GetByName(contentTypeName);
                Assert.IsNotNull(ContentType.GetByName(contentTypeName).FieldSettings.FirstOrDefault(f => f.Name == "OurNewField"));
            }
            finally
            {
