...
{
	/// <summary>
	///This is a test class for ContentRepository.Storage.VersionNumber and is intended
	///to contain all ContentRepository.Storage.VersionNumber Unit Tests
	///</summary>
	[TestClass()]
    public class VersionNumberTest : TestBase
	{
        ...
        public void VersionNumber_Parsing()
        {
            ...
            var expected = ContentRepository.Storage.SR.GetString(ContentRepository.Storage.SR.Exceptions.VersionNumber.InvalidVersionFormat);
        ...
        public void VersionNumber_ParsingVersionStatus()
        {
            ...
            var expected = String.Format(ContentRepository.Storage.SR.GetString(ContentRepository.Storage.SR.Exceptions.VersionNumber.InvalidVersionStatus_1), statusString);
