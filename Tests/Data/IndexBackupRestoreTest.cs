...
namespace ContentRepository.Tests.Data
{
    ...
    public class IndexBackupRestoreTest : TestBase
    {
        ...
        //        ContentRepository.Storage.StorageContext.Search.IndexDirectoryBackupPath);
        //    var backupZipPath = System.IO.Path.Combine(backupDirPath, Search.Indexing.BackupTools.BACKUPFILENAME);
        //    var recoveredZipPath = System.IO.Path.Combine(backupDirPath, Search.Indexing.BackupTools.RECOVEREDFILENAME);

        //    var dummyNodesArray = Search.ContentQuery.Query("Type:ContentType .SKIP:10 .TOP:3 .AUTOFILTERS:OFF").Nodes.ToArray();
        ...
        //    Search.Indexing.BackupTools.BackupIndex();
        ...
        //            break;
        //    }
        //    var backup = ContentRepository.Storage.Data.DataProvider.RecoverIndexBackupFromDb(recoveredZipPath);
