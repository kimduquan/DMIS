...
namespace ContentRepository.Tests.Data
{
    [TestClass]
    public class DataRowTimestampTest : TestBase
    {
        ...
        public void Indexing_SavingRepairsDuplicatedNodes()
        {
            ...
            var result1 = ContentQuery.Query("Name:CarBadIndex", new QuerySettings { EnableAutofilters = FilterStatus.Disabled, EnableLifespanFilter = FilterStatus.Disabled });

            content.ContentHandler.Index++;
            content.Save();

            var children2 = ((IFolder)TestRoot).Children.ToArray();
            var result2 = ContentQuery.Query("Name:CarBadIndex", new QuerySettings { EnableAutofilters = FilterStatus.Disabled, EnableLifespanFilter = FilterStatus.Disabled });
        ...
        {
            return ContentQuery.Query("Id:" + versionid, new QuerySettings { EnableAutofilters = FilterStatus.Disabled }).Count == 1;
        }
        ...
        internal static void DeleteVersionIdFromIndexingHistory(int versionId)
        {
            ...
            var storage = (Dictionary<int, Timestamps>)historyAcc.GetField("_storage");
            storage.Remove(versionId);
        }
        internal static void ResetIndexingHistory()
        {
            LuceneManager._history = new IndexingHistory();
        }
        ...
        public void Indexing_ExecutingUnprocessedDoesNotDuplicate()
        {
            ...
            var query = ContentQuery.CreateQuery(".COUNTONLY Name:" + contentName, new QuerySettings { EnableAutofilters = FilterStatus.Disabled, EnableLifespanFilter = FilterStatus.Disabled });
            ...
            count = ContentQuery.Query(".COUNTONLY +Index:2 +Name:" + contentName, new QuerySettings { EnableAutofilters = FilterStatus.Disabled, EnableLifespanFilter = FilterStatus.Disabled }).Count;
