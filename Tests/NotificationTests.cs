...
using Messaging;
using config = Messaging.Configuration;
...
namespace ContentRepository.Tests
{
    ...
    public class NotificationTests : TestBase
    {
        ...
        private class NotificationHandlerAccessor
        {
            ...
            {
                type = TypeHandler.GetType("Messaging.NotificationHandler");
            }
        ...
        public void Notification_Event_Modification_MajorOnly()
        {
            ...
            var events = (Event[])Event.GetAllEvents();
            Assert.IsTrue(events.Length == 2, "#1");
            Assert.IsTrue(events[0].NotificationType == NotificationType.MajorVersionModified, "#2");
            Assert.IsTrue(events[1].NotificationType == NotificationType.MajorVersionModified, "#3");
        }
        [TestMethod]
        ...
        {
            var source = Content.CreateNew("SystemFolder", TestRoot, "source2");
            source.Save();
            var subFolder = Content.CreateNew("SystemFolder", source.ContentHandler, "folder1");
            subFolder.Save();
            var doc = Content.CreateNew("Car", subFolder.ContentHandler, "car_Move");
            doc.Save();
            var target = Content.CreateNew("SystemFolder", TestRoot, "target2");
            target.Save();
        ...
        public void Notification_Event_MoveWithDeepSubscription()
        {
            ...
            doc.Save();
            var target = Content.CreateNew("SystemFolder", TestRoot, "target");
            target.Save();
        ...
        public void Notification_Message1()
        {
            ...
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg2", 1, 1, NotificationType.MinorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg2", 1, 1, NotificationType.MinorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MajorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MajorVersionModified, "\\Admin"); WaitAMoment();
            Event.CreateAndSave("/Root/_NotificationTests/car_msg2", 1, 1, NotificationType.MajorVersionModified, "\\Admin"); WaitAMoment();

            var subscriptions = NotificationHandlerAccessor.CollectEventsPerSubscription(NotificationFrequency.Immediately, DateTime.UtcNow).ToArray();
            ...
            try
            {
                events0 = subscriptions[0].RelatedEvents.ToArray();
            ...
            catch
            {
                ...
                foreach (var @event in events0)
                {
                    sb.AppendFormat("| {0}, {1}, {2}, {3}, {4}, {5} |", @event.EventId, @event.NotificationTypeId, @event.NotificationType,
                        @event.Who, @event.When, @event.ContentPath);
                }
                Debug.WriteLine(sb);
                throw;
            }
            ...
            try
            {
                events1 = subscriptions[1].RelatedEvents.ToArray();
        ...
        public void Notification_Message2()
        {
            ...
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg2", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg2", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MajorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg1", 1, 1, NotificationType.MajorVersionModified, "\\Admin");
            Event.CreateAndSave("/Root/_NotificationTests/car_msg2", 1, 1, NotificationType.MajorVersionModified, "\\Admin");

            NotificationHandler.GenerateMessages(NotificationFrequency.Immediately, DateTime.UtcNow);
        ...
        public void Notification_Message_LastExecutionTime()
        {
            ...
            Event.CreateAndSave("/Root/_NotificationTests", 1, 1, NotificationType.MajorVersionModified, "\\Admin");
            subscriptions = NotificationHandlerAccessor.CollectEventsPerSubscription(NotificationFrequency.Immediately, DateTime.UtcNow).ToArray();
            Assert.IsTrue(subscriptions.Count() == 1, "#1");

            Event.CreateAndSave("/Root/_NotificationTests", 1, 1, NotificationType.MinorVersionModified, "\\Admin");
            subscriptions = NotificationHandlerAccessor.CollectEventsPerSubscription(NotificationFrequency.Immediately, DateTime.UtcNow).ToArray();
        ...
        {
            var lastProcessTimeAcc = new PrivateType(typeof(LastProcessTime));
            lastProcessTimeAcc.SetStaticField("_nextDaily", null);
            lastProcessTimeAcc.SetStaticField("_nextWeekly", null);
            lastProcessTimeAcc.SetStaticField("_nextMonthly", null);
            ...
            Event.CreateAndSave(content1path, 1, 1, NotificationType.Created, "\\Admin", DateTime.Parse("2011-03-22 08:00:01"));
            Event.CreateAndSave(content1path, 1, 1, NotificationType.MinorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:05:02")); WaitAMoment();
            Event.CreateAndSave(content2path, 1, 1, NotificationType.MinorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:10:03")); WaitAMoment();
            Event.CreateAndSave(content1path, 1, 1, NotificationType.MinorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:15:04")); WaitAMoment();
            Event.CreateAndSave(content2path, 1, 1, NotificationType.MinorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:20:05")); WaitAMoment();
            Event.CreateAndSave(content1path, 1, 1, NotificationType.MinorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:25:06")); WaitAMoment();
            Event.CreateAndSave(content1path, 1, 1, NotificationType.MajorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:30:07")); WaitAMoment();
            Event.CreateAndSave(content1path, 1, 1, NotificationType.MinorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:35:08")); WaitAMoment();
            Event.CreateAndSave(content1path, 1, 1, NotificationType.MajorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:40:09")); WaitAMoment();
            Event.CreateAndSave(content2path, 1, 1, NotificationType.MajorVersionModified, "\\Admin", DateTime.Parse("2011-03-22 08:45:10")); WaitAMoment();
        ...
        private static void CreateResourceFile()
        {
            ...
            var resFile = new ContentRepository.i18n.Resource(locFolder);
            ...
            resFile.Binary.FileName = resFile.Name;
            resFile.Save();
        }
