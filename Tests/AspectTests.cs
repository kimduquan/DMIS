...
<Fields>
    <AspectField name='Field2' type='ShortText' />
        ...
        public void Aspect_PropertySetAndPropertyNotCreated()
        {
            ...
            aspect.AspectDefinition = @"<AspectDefinition xmlns='http://schemas.com/ContentRepository/AspectDefinition'>
<Fields>
    <AspectField name='Field1' type='ShortText' />
    <AspectField name='Field2' type='ShortText' />
  </Fields>
...
<Fields>
    <AspectField name='Field1' type='ShortText' />
        ...
        public void Aspect_ReferenceExportImport()
        {
            ...
            RepositoryConfiguration.WorkingMode = new RepositoryConfiguration.WorkingModeFlags
            {
                Exporting = true,
                Importing = false,
                Populating = false,
