...
namespace ContentRepository.Storage.Events
{
    ...
    {
        public static readonly string NOTIFICATION = "Messaging.NotificationObserver";
        public static readonly string WORKFLOWNOTIFICATION = "Workflow.WorkflowNotificationObserver";
    }
