...
namespace ContentRepository.Storage
{
	...
	public static class ActiveSchema
	{
		public static readonly List<string> NodeAttributeNames = new List<string>(new string[]{
			...
			"CreationDate", "CreatedBy", "ModificationDate", "ModifiedBy", "IsSystem", "ClosestSecurityNodeId", "SavingState" });
		...
		static ActiveSchema()
		{
            ...
            _nodeAttributeDataTypes.Add(NodeAttribute.ClosestSecurityNodeId, DataType.Int);
		...
		{
			get { return ContentRepository.Storage.Data.DataProvider.Current.DateTimeMinValue; }
		}
		/// <summary>
		...
		{
			get { return ContentRepository.Storage.Data.DataProvider.Current.DateTimeMaxValue; }
		}
		/// <summary>
        ...
        {
            get { return ContentRepository.Storage.Data.DataProvider.Current.DecimalMinValue; }
        }
        /// <summary>
        ...
        {
            get { return ContentRepository.Storage.Data.DataProvider.Current.DecimalMaxValue; }
        }
