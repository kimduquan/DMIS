...
using ContentRepository.Storage.Caching;
...
namespace ContentRepository
{
    public static class DistributedApplication
    {
                    ...
                    lock (_syncRoot)
                    {
                        if (_currentChannel == null)
                        {
                            ...
                            catch (Exception e) //logged
                            {
                                ...
                                //if msmq is configured, but the configuration is not correct, that makes  unusable 
        ...
        private static Type GetChannelProviderType()
        {
            ...
            Type channelAdapterType = ContentRepository.Storage.TypeHandler.GetType(channelProviderTypeName);
