...
namespace ContentRepository.Storage
{
	...
	static class SR
	{
        ...
        static SR()
        {
            var resManType = TypeHandler.GetTypesByInterface(typeof(IResourceManager))
		...
		internal static class Exceptions
		{
			...
			internal static class Configuration
			{
				...
				internal static string Msg_InvalidDataProviderImplementation = "DataProvider implementation must be inherited from ContentRepository.Storage.Data.DataProvider";
				internal static string Msg_AccessProviderImplementationDoesNotExist = "AccessProvider implementation does not exist";
				internal static string Msg_InvalidAccessProviderImplementation = "AccessProvider implementation must be inherited from ContentRepository.Storage.Security.AccessProvider";
                ...
                internal static string Msg_InvalidPasswordHashProviderImplementation = "PasswordHashProvider implementation must be inherited from ContentRepository.Storage.Security.PasswordHashProvider";
