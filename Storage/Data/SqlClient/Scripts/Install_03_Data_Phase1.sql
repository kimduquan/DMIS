...
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (null, 'Folder', @id, 'ContentRepository.Folder')
DECLARE @folderId int
SELECT @folderId = @@IDENTITY
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (null, 'Group', @id, 'ContentRepository.Group')
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (null, 'User', @id, 'ContentRepository.User')
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (null, 'PortalRoot', @id, 'ContentRepository.PortalRoot')
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (@folderId, 'SystemFolder', @id, 'ContentRepository.SystemFolder')
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (@folderId, 'Domains', @id, 'ContentRepository.Folder')

DECLARE @folderPropertySetId int
SELECT @folderPropertySetId = PropertySetId FROM SchemaPropertySets WHERE Name = 'Folder'
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (@folderPropertySetId, 'Domain', @id, 'ContentRepository.Domain')
INSERT INTO [dbo].[SchemaPropertySets] ([ParentId], [Name], [PropertySetTypeId], [ClassName])
	VALUES (@folderPropertySetId, 'OrganizationalUnit', @id, 'ContentRepository.OrganizationalUnit')
