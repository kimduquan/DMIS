...
namespace ContentRepository.Storage.Data
{
    public static class RepositoryConfiguration
    {
        ...
        private static readonly string DataProviderSectionKey = "dmis/dataHandling";
        ...
        private static string DefaultConnectionString = "Persist Security Info=False;Initial Catalog=ContentRepository;Data Source=MyContentRepositoryDatasource;User ID=ContentRepository;password=ContentRepository";
        private static string DefaultDataProviderClassName = "ContentRepository.Storage.Data.SqlClient.SqlProvider";
        private static string DefaultAccessProviderClassName = "ContentRepository.Security.DesktopAccessProvider";
        private static string DefaultPasswordHashProviderClassName = typeof(ContentRepository.Storage.Security.DMISPasswordHashProvider).FullName;
        private static string DefaultOutdatedPasswordHashProviderClassName = typeof(ContentRepository.Storage.Security.Sha256PasswordHashProviderWithoutSalt).FullName;
        ...
        public static readonly string NotificationSectionKey = "dmis/notification";
