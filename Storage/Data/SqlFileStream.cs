...
namespace ContentRepository.Storage.Data
{
    ...
    /// </summary>
    public class SqlFileStream : Stream
    {
        //========================================================= Properties
        ...
        public SqlFileStream(long size, int binaryPropertyId, FileStreamData fileStreamData = null)
        {
            _length = size;
        ...
        {
            throw new NotSupportedException("SqlFileStream does not support setting length.");
        }

        public override void Write(byte[] buffer, int offset, int count)
        {
            throw new NotSupportedException("SqlFileStream does not support writing.");
        }

        public override void Flush()
        {
            throw new NotSupportedException("SqlFileStream does not support flushing.");
        }
