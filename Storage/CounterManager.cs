...
namespace ContentRepository
{
    public class CounterManager
    {
        ...
        private static readonly string PERFORMANCECOUNTER_CATEGORYNAME = "DMIS";
        ...
        private IEnumerable<PerformanceCounter> Counters
        {
        ...
        private PerformanceCounter GetCounter(string counterName)
        {
        ...
        private static PerformanceCounterCategory CreateCategory()
        {
            ...
            return PerformanceCounterCategory.Create(PERFORMANCECOUNTER_CATEGORYNAME, "Performance counters",
