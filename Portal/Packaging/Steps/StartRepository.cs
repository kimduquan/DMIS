...
namespace Packaging.Steps
{
    public class StartRepository : Step
    {
        ...
        public override void Execute(ExecutionContext context)
        {
            ...
            if (IndexPath == null)
            {
                indexPath = ConfigurationManager.AppSettings["IndexDirectoryPath"];
            ...
            Repository.Start(new RepositoryStartSettings
            {
                ...
                //PluginsPath = PluginsPath ?? System.IO.Path.GetFullPath(System.IO.Path.Combine(context.PackagePath, "..\\temp")),
