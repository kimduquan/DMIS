...
namespace Portal.UI.PortletFramework
{
    public abstract class PortletBase : WebPart, IWebEditable
    {
        ...
        protected Portal.UI.PortletFramework.Xslt.XslTransformExecutionContext PinnedXsltContext;
        // Events /////////////////////////////////////////////////////////////////
        ...
        protected virtual void RenderWithXslt(HtmlTextWriter writer)
        {
            ...
            var contentModel = model as ContentRepository.Content;
            if (contentModel != null && ContentRepository.Content.ContentNavigatorEnabled)
            {
                withNav = true;
                xml = new ContentRepository.Xpath.NavigableContent(contentModel);
            }
            else
            {
        ...
        protected virtual EditorPartCollection GetDefaultEditorPart()
        {
            ...
            propertyEditorPart.HiddenCategories = this.HiddenPropertyCategories == null ? null : this.HiddenPropertyCategories.Select(pc => ResourceManager.Current.GetString(pc)).ToList();
