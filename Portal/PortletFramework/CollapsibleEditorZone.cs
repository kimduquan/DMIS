...
namespace Portal.UI.PortletFramework
{
    public class CollapsibleEditorZone : EditorZone
    {
        ...
        public override string InstructionText
        {
            get
            {
                var srm = ContentRepository.i18n.ResourceManager.Current;
        ...
        public override string HeaderText
        {
            get
            {
                ...
                try
                {
                    ...
                    if (p != null)
                        typeName = ResourceManager.Current.GetString(p.Name) ?? string.Empty;
                    else
        ...
        protected override void RaisePostBackEvent(string eventArgument)
        {
            ...
            switch (eventArgument)
            {
                ...
                case "ok":
                    ...
                    if (this._applyError)
                    {
                        Portal.UI.Controls.PortalRemoteControl.ToggleEditorZone(this.WebPartToEdit, this.Page);
                        return;
                    }
                    if (wpm != null)
                    {
