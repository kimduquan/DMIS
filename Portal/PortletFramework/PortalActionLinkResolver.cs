...
{
    enum WebdavModes { Open, Browse }

    [Obsolete("This class was obsoleted by the ApplicationModel namespace.")]
    public class PortalActionLinkResolver : IActionLinkResolver
    {
        ...
        public string ResolveRelative(string targetPath, string actionName, string backUrl)
        {
            ...
            if (targetNode != null)
            {
                ...
                if (targetNode.Security.GetPermission(ptype) != ContentRepository.Storage.Security.PermissionValue.Allow)
                    return String.Empty;
            }
