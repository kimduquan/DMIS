...
{
    /// <summary>
    /// <c>ContentView</c> is a class responsible for enabling various visualizations of the <see cref="ContentRepository.Content ">Content</see> class that it owns.
    /// </summary>
    /// <remarks>
    /// The two most important properties of <c>ContentView</c> is the collection of <see cref="Portal.UI.Controls.FieldControl">FieldControl</see>s and the <see cref="ContentRepository.Content ">Content</see> it references.
    /// These two parts are closely related as every <see cref="Portal.UI.Controls.FieldControl">FieldControl</see> wraps a #Field# defined within its <see cref="ContentRepository.Content ">Content</see>.
    /// 
    /// Basically the <c>ContentView</c> is a visualizer of the <see cref="ContentRepository.Content ">Content</see> assigned to it when created. The <see cref="Portal.UI.Controls.FieldControl">FieldControl</see>s of this ContentView
    /// each visualize a #Field# defined within this <see cref="ContentRepository.Content ">Content</see> (but not necessary all of them). 
    /// 
    /// Another important role of the <c>ContentView</c> is automatically utilizing the pre-defined <see cref="Portal.UI.ViewMode">ViewMode</see>s 
    /// It renders itself and all of its <see cref="Portal.UI.Controls.FieldControl">FieldControl</see>s according to the <see cref="Portal.UI.ViewMode">ViewMode</see> assigned to it when created.
    /// </remarks>
    /// <example>
    /// 
    ...
    public abstract class ContentView : UserControl, INamingContainer
    {
        ...
        /// <summary>
        /// Gets the <see cref="Portal.UI.ViewMode">ViewMode</see> in which the content should be viewed. This value determines the DefaultControlRenderMode property.
        /// </summary>
        public ViewMode ViewMode { get; private set; }

        /// <summary>
        /// Gets the <see cref="Portal.UI.Controls.FieldControlRenderMode">FieldControlRenderMode</see> which will be the default render mode for <see cref="Portal.UI.Controls.FieldControl">FieldControl</see>s. This value is derermined by the ViewMode property.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the friendly name of the view. By default it is the title of the <see cref="ContentRepository.Content"> it wraps.</see>
        /// </summary>
        public string DisplayName { get; set; }

        /// <summary>
        /// Gets or sets the  description of the view. By default it is the description of the <see cref="ContentRepository.Content"> it wraps.</see>
        /// </summary>
        public string Description { get; set; }

        /// <summary>
        /// Gets or sets the icon of the view. By default it is the icon of the <see cref="ContentRepository.Content"> it wraps.</see>
        /// </summary>
        public string Icon { get; set; }

        /// <summary>
        /// Gets the list of owned <see cref="Portal.UI.Controls.FieldControl">FieldControl</see>s. ContentView is build around this collection.
        /// </summary>
        public List<FieldControl> FieldControls { get; private set; }

        private Exception _contentException;
        /// <summary>
        ...
        {
            get { return _contentException; }
            set { _contentException = value; }
        }
        public bool NeedToValidate { get; set; }
        public bool IsUserInputValid { get; protected set; }
        ...
        /// <summary>
        /// Gets the <see cref="ContentRepository.Storage.Node">ContentHandler</see> wrapped by the <see cref="ContentRepository.Content ">Content</see> which is owned by this ContentView. (Is a shortcut)
        /// </summary>
        ...
        /// <summary>
        /// Gets the ContentType property of the <see cref="ContentRepository.Content ">Content</see> owned by this ContentView. (Is a shortcut)
        /// </summary>
        ...
        /// <summary>
        /// Gets the Name of the ContentType of the <see cref="ContentRepository.Content ">Content</see> owned by this ContentView in a safe way. (Is a shortcut)
        /// </summary>
        ...
        protected string GetValue(string name, bool storedData = false, CultureInfo cultureInfo = null)
        {
            try
            {
                return GetValue(name, this.Content, storedData, cultureInfo);
            }
        ...
        /// <summary>
        /// Get the raw value of a field. This makes sense only in case of 
        /// number or datetime fields where the field may produce a special
        /// string representation of its value (e.g. a number with thousand 
        /// separators or a currency value extended with the currency sign).
        /// </summary>
        ...
        protected string GetRawValue(string name)
        {
            try
            {
                return GetValue(name, this.Content, false, null, false);
            }
            catch (Exception ex) //logged
            {
                Logger.WriteException(ex);
        ...
        /// <summary>
        /// Creates the ContenView for the <see cref="ContentRepository.Content ">Content</see>.
        /// </summary>
        ...
        /// <summary>
        /// Updates and validates data of <see cref="Portal.UI.Controls.FieldControl">FieldControl</see>s owned by this ContentView
        /// </summary>
        ...
        /// <summary>
        /// Updates data of <see cref="Portal.UI.Controls.FieldControl">FieldControl</see>s owned by this ContentView
        /// </summary>
        /// <param name="withValidate">Whether the Updates data of <see cref="ContentRepository.Content">Content</see>s owned by this ContentView data should be validated after updating. When <c>true</c> content validation errors will be displayed (if any), when <c>false</c>, these errors will not be visible.</param>
        public void UpdateContent(bool withValidate)
        {
            using (var traceOperation = Logger.TraceOperation("ContentView.UpdateContent"))
            {
                ...
                //inherited content views can execute a custom logic - e.g. validation - in this method
        ...
        {
            return ResourceManager.Current.GetStringOrNull(className, name, System.Globalization.CultureInfo.CurrentUICulture);
        }
