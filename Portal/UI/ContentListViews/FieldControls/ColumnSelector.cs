...
using Handler = Portal.UI.ContentListViews.Handlers.ListView;
using WebControls = System.Web.UI.WebControls;
using Portal.UI.ContentListViews.Handlers;

namespace Portal.UI.ContentListViews.FieldControls
{
    public class ColumnSelector : FieldControl
    {
        ...
        protected void ColumnList_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            if (ha != null)
            {
                ...
                {
                    ha.Items.Add(new ListItem(ResourceManager.Current.GetString("ManageFields", "HAlign-" + haName), haName));
                    index++;
            ...
            if (wm != null)
            {
                ...
                {
                    wm.Items.Add(new ListItem(ResourceManager.Current.GetString("ManageFields", "Wrap-" + wmName), wmName));
                    index++;
            ...
            if (afs != null)
            {
                ...
                if (lblType != null && !string.IsNullOrEmpty(afs.ShortName))
                    lblType.Text = ResourceManager.Current.GetString("ManageFields", afs.ShortName);
            }
