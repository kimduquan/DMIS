...
namespace Portal.UI
{
    public static class UITools
    {
        ...
        public static string GetFriendlyDate(DateTime date)
        {
            ...
            string secondText = ResourceManager.Current.GetString("Portal", "SecondMessage");
            string minuteText = ResourceManager.Current.GetString("Portal", "MinutesMessage");
            string hoursext = ResourceManager.Current.GetString("Portal", "HoursMessage");
            string yesterdayAt = ResourceManager.Current.GetString("Portal", "YesterdayAt");
            string atString = ResourceManager.Current.GetString("Portal", "At");
        ...
        /// if the text is a recognisable resource editor markup.
        /// </summary>
        ...
        public static string GetSafeText(string text)
        {
            ...
            if (PortalContext.Current.IsResourceEditorAllowed && ResourceManager.IsEditorMarkup(text))
                return text;
