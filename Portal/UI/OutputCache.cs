...
namespace Portal.UI
{
    ...
    public class OutputCache
    {
        ...
        public static string GetCacheKey(string customCacheKey, string appNodePath, string portletClientId, bool cacheByPath, bool cacheByParams, bool cacheByLanguage)
        {
