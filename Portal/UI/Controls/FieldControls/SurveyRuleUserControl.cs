...
namespace Portal.UI.Controls
{
    public class SurveyRuleUserControl : System.Web.UI.UserControl
    {
        ...
        public void ListItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            if (dataItem == null)
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Survey", "ListViewDataItemError") });
                return;
            }
            ...
            if (surveyRule == null)
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Survey", "SurveyRuleError") });
                return;
            }
