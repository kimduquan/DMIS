    ...
    public class UrlList : GridEditor<UrlItem>
    {
        ...
        protected override object GetDataFromDataList()
        {
            if (this.DataListView == null)
            {
                ...
                if (tbUrlList != null)
                {
                    var dict = Portal.Site.ParseUrlList(tbUrlList.Text);
                ...
                return Portal.Site.ParseUrlList(_inputTextBox.Text);
            }
        ...
        public override void SetData(object data)
        {
            ...
            _inputTextBox.Text = Portal.Site.UrlListToString(dictUrls);
        ...
        private string GetUrlListStringFromData()
        {
            ...
            return Portal.Site.UrlListToString(dict);
        }
        ...
        {
            var dict = Portal.Site.ParseUrlList(data);
