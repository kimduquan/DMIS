...
using SnFields = ContentRepository.Fields;
...
namespace Portal.UI.Controls
{
	...
	public class HyperLink : FieldControl, INamingContainer, ITemplateFieldControl
	{
		...
		private string _textLabel = SNSR.GetString(SNSR.FieldControls.HyperLink_TextLabel); // "Link text";
        private string _hrefLabel = SNSR.GetString(SNSR.FieldControls.HyperLink_HrefLabel); // "URL";
        private string _hrefImageLabel = SNSR.GetString(SNSR.FieldControls.HyperLink_HrefImageLabel); // "Image source";
        private string _targetLabel = SNSR.GetString(SNSR.FieldControls.HyperLink_TargetLabel); // "Target window";
        private string _titleLabel = SNSR.GetString(SNSR.FieldControls.HyperLink_TitleLabel); // "Link title (tooltip)";
	    ...
	    public string HrefLabel
	    {
            get
            {
                return this.FieldName == "DefaultValue" || ((HyperLinkFieldSetting) this.Field.FieldSetting).UrlFormat != UrlFormat.Picture
                           ? _hrefLabel
                           : _hrefImageLabel;
            }
        ...
        private void ManipulateTemplateControls()
        {
            ...
            if (hrefLabel != null) hrefLabel.Text = this.HrefLabel;
