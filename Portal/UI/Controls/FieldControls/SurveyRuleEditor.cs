...
namespace Portal.UI.Controls
{
    public class SurveyRuleEditor : FieldControl
    {
        ...
        private void SetQuestions()
        {
            ...
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Survey", "ReferenceFieldError") });
                return;
            }
            ...
            if (questions == null)
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Survey", "OriginalValueError") });
                return;
            }
            ...
            for (var i = questions.Count - 1; i >= 0; i--)
            {
                ...
                if (choiceTypeIds.Contains(questionTypeId))
                {
                    ...
                    var chfs = q.FieldSetting as ChoiceFieldSetting;
                    if (chfs != null)
