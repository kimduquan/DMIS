Type.registerNamespace('Portal.UI.Controls.RichTextEditor');

Portal.UI.Controls.RichTextEditor = function(element) {
    Portal.UI.Controls.RichTextEditor.initializeBase(this, [element]);
    // internals	
    this._config = null;
...
Portal.UI.Controls.RichTextEditor.prototype = {
  ...
  initialize: function() {
    ...
    Portal.UI.Controls.RichTextEditor.callBaseMethod(this, 'initialize');
    ...
    if (this.options !== null) {
      // we r happy
      try {
        this._config = eval('(' + this.options + ')');
      }
      catch (err) {
  ...
  dispose: function() {
    ...
    Portal.UI.Controls.RichTextEditor.callBaseMethod(this, 'dispose');
  },
  //
...
Portal.UI.Controls.RichTextEditor.registerClass('Portal.UI.Controls.RichTextEditor',Sys.UI.Control);
