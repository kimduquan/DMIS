...
[assembly: WebResource("Portal.UI.Controls.RateControl.js", "application/x-javascript")]
...
namespace Portal.UI.Controls
{
    ...
    public class RateControl : Panel, IScriptControl, INamingContainer
    {
        ...
        {
            var scriptRef = new ScriptReference { Path = this.Page.ClientScript.GetWebResourceUrl(this.GetType(), "Portal.UI.Controls.RateControl.js") };
