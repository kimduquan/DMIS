...
{
    internal class DataSourceView : System.Web.UI.DataSourceView
    {
        ...
        internal static string DefaultViewName = "DefaultView";
        ...
        protected override IEnumerable ExecuteSelect(DataSourceSelectArguments selectArgs)
        {
            ...
            if (this.Content != null && !string.IsNullOrEmpty(this.MemberName))
            {
                ...
                OnSelected(new DataSourceStatusEventArgs(0));
            ...
            if (dataList != null)
                this.OnSelected(new DataSourceStatusEventArgs(dataList.Count()));
        ...
        private IEnumerable<Content> GetContents(IEnumerable<Node> nodes, bool enforceSettings)
        {
            ...
            OnSelected(new DataSourceStatusEventArgs(contents.Count));
        ...
        private IEnumerable<Content> GetChildren()
        {
            ...
            OnSelected(new DataSourceStatusEventArgs(children.Count));
