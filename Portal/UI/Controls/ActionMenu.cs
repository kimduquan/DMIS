...
[assembly: WebResource("Portal.UI.Controls.ActionMenu.js", "application/x-javascript")]
namespace Portal.UI.Controls
{
    ...
    public class ActionMenu : Label, IScriptControl, IActionUiAdapter
    {
        ...
        {
            var descriptor = new ScriptControlDescriptor("Portal.UI.Controls.ActionMenu", ClientID);
        ...
        {
            yield return new ScriptReference("Portal.UI.Controls.ActionMenu.js", GetType().Assembly.FullName);
        }
