...
[assembly: WebResource("Portal.UI.Controls.SNDialog.js", "application/x-javascript")]
[assembly: TagPrefix("Portal.UI.Controls", "sn")]
namespace Portal.UI.Controls
{
    ...
    public class SNDialog : CompositeControl, IScriptControl
    {
        ...
        protected virtual IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            //reference.Path = this.Page.ClientScript.GetWebResourceUrl(this.GetType(), "Portal.UI.Controls.SNDialog.js");
            //return new ScriptReference[] { reference };
            return new ScriptReference[] { };
        }
        protected virtual IEnumerable<ScriptDescriptor> GetScriptDescriptors()
        {
            /*ScriptControlDescriptor descriptor = new ScriptControlDescriptor("Portal.UI.Controls.SNDialog", this.ClientID);
            //
            // Add properties here
            //
