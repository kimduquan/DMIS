...
Type.registerNamespace('Portal.UI.Control.SNDialog');

//
// Define the control properties.
//
Portal.UI.Control.SNDialog = function(element){
    Portal.UI.Control.SNDialog.initializeBase(this, [element]);
...
//
Portal.UI.Control.SNDialog.prototype = {

    initialize: function(){
        Portal.UI.Control.SNDialog.callBaseMethod(this, 'initialize');
    ...
    dispose: function(){
        Portal.UI.Control.SNDialog.callBaseMethod(this, 'dispose');
    },
...
Portal.UI.Control.SNDialog.registerClass('Portal.UI.Control.SNDialog', Sys.UI.Control);
