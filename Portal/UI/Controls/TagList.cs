...
[assembly: WebResource("Portal.UI.Controls.TagList.js", "application/x-javascript")]
namespace Portal.UI.Controls
{
    /// <summary>
    /// <c>TagList</c> is a class responsible for displaying tags of a <see cref="ContentRepository.Content ">Content</see> in various ways.
    ...
    public class TagList : FieldControl, IScriptControl
    {
        ...
        public TagList()
        {
            ...
            _btnAddTag = new Button { ID = "btnAddTag", Text = SNSR.GetString(SNSR.FieldControls.TagList_AddTag), OnClientClick = "return false;" };
        ...
        public override object GetData()
        {
            ...
            {
                var msgbody = "\n";
                var msgEnd = SNSR.GetString(SNSR.FieldControls.TagList_BlacklistedTag);
                if (_bannedTagsList.Count > 1)
                {
                    msgEnd = SNSR.GetString(SNSR.FieldControls.TagList_BlacklistedTags);
                }
        ...
        public IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            reference.Path = this.Page.ClientScript.GetWebResourceUrl(this.GetType(), "Portal.UI.Controls.TagList.js");
