...
namespace Portal
{
    public class QueryBuilder
    {
        ...
        private static readonly Dictionary<Type, string> TYPE_NAMES = new Dictionary<Type, string>
        {
            ...
            {typeof(ContentRepository.Storage.Schema.NodeType), "nodeType"},
            {typeof(VersionNumber), "version"},
            {typeof(IEnumerable<Node>), "nodes"},
            {typeof(IEnumerable<ContentType>), "contentTypes"},
        };
