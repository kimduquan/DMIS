    ...
    public class WorkspaceHelper
    {
        ...
        public static IEnumerable<WorkspaceGroupList> GetWorkspaceGroupLists(User user)
        {
            ...
            var groups = ContentQuery.Query("+TypeIs:Group +Workspace:* -InTree:@0", settings,
                new[] { Repository.ImsFolderPath, Repository.ContentTemplateFolderPath }).Nodes;
            ...
            using (new SystemAccount())
            {
                ...
                var wsGroups = groups.Select(g => new WorkspaceGroup { Workspace = ((Group)g).Workspace, Group = (g as Group) });
