...
namespace Portal.OData.Parser
{
    internal class ODataParser
    {
        ...
        private void parseFilterExpr(string filter)
        {
            ...
            //var final = Expression.Lambda(expr, Expression.Parameter(typeof(Node), "x"));
            var final = Expression.Lambda(expr, this.Builder.x);
            this.req.Filter = final;
        }
        //private void parseOrderByExpr(string sort)
        //{
        //    this.lexer = new ODataLexer(sort);
        //    var sortInfo = this.parseOrderBy();
        //    var token = this.lexer.Token;
        //    if (token != null && token.TokenType != TokenType.EOF)
        //        throw SyntaxError(String.Concat("Unexpected ", token.TokenType.ToString(), " in $orderby: '", token.Value, "'."));
        //    this.req.Sort = sortInfo;
        //}
        //internal void parseSkipExpr()
        //{
        //    this.lexer = new ODataLexer(this.req.Skip);
        //    var token = this.lexer.Token;
        //    if (this.lexer.Token.TokenType != TokenType.Digits)
        //        throw SyntaxError(String.Concat("Invalid expression in $skip: '", token.Value, "'."));
        //    var expr = this.parseNumberLiteral();
        //    token = this.lexer.Token;
        //    if (token != null && token.TokenType != TokenType.EOF)
        //        throw SyntaxError(String.Concat("Unexpected ", token.TokenType.ToString(), " in $skip: '", token.Value, "'."));
        //    this.product.Skip = expr;
        //}
        //internal void parseTopExpr()
        //{
        //    this.lexer = new ODataLexer(this.req.Top);
        //    var token = this.lexer.Token;
        //    if (this.lexer.Token.TokenType != TokenType.Digits)
        //        throw SyntaxError(String.Concat("Invalid expression in $top: '", token.Value, "'."));
        //    var expr = this.parseNumberLiteral();
        //    token = this.lexer.Token;
        //    if (token != null && token.TokenType != TokenType.EOF)
        //        throw SyntaxError(String.Concat("Unexpected ", token.TokenType.ToString(), " in $top: '", token.Value, "'."));
        //    this.product.Top = expr;
        //}
        //internal void parseSelectExpr()
        //{
        //    this.lexer = new ODataLexer(this.req.Select);
        //    var expressions = new List<object>();

        //    var expr = this.parseExpr();
        //    expressions.Add(expr);
        //    var token = this.lexer.Token;
        //    while (token != null && token.Value == Strings.COMMA)
        //    {
        ...
        //        throw SyntaxError(String.Concat("Unexpected ", token.TokenType.ToString(), " in $select: '", token.Value, "'."));

        //    this.product.Select = expressions;
        //}
        //internal void parseExpandExpr()
        //{
        //    this.lexer = new ODataLexer(this.req.Expand);
        //    this.product.Expand = this.parseExpand();
        //    var token = this.lexer.Token;
        //    if (token.TokenType != TokenType.EOF)
        //        throw SyntaxError(String.Concat("Unexpected ", token.TokenType.ToString(), " in $expand: '", token.Value, "'."));
        //}
        /*
        ...
        */
        ...
        //private IEnumerable<SortInfo> parseOrderBy()
        //{
        //    //bnf: OrderByExpr:     Expr [ "asc" | "desc"] *( "," Expr [ "asc" | "desc"] )
        //    var expr = this.parseExpr();
        //    if (expr == null)
        //        return null;
        //    var items = new List<OrderByItem>();  // [{expr:expr, dir:"asc"}]
        //    var dir = "asc";
        //    var token = this.lexer.Token;
        ...
        //        token = this.lexer.Token;
        //    }
        //    items.Add(new OrderByItem { Expr = expr, Direction = dir });

        //    while (token.Value == Strings.COMMA)
        //    {
        //        this.lexer.NextToken();
        //        token = this.lexer.Token;
        //        expr = this.parseExpr();
        ...
        //internal Expression[] parseExpand()
        //{
