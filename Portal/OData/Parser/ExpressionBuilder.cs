...
namespace Portal.OData.Parser
{
    internal class ExpressionBuilder
    {
        ...
        public ParameterExpression x = Expression.Parameter(typeof(ContentRepository.Content), "x");
        ...
        internal Expression BuildSimpleBinary(Expression expr, Expression right, string @operator)
        {
            ...
            switch (@operator)
            {
                ...
                default: throw new NotImplementedException("Unknown operator: " + @operator);
            }
