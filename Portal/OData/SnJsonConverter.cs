...
namespace Portal.OData
{
    public static class SnJsonConverter
    {
        ...
        /// <summary>
        /// Serializes a single <see cref="ContentRepository.Content"/> into JSON with the specified options.
        /// </summary>
        ...
        /// <summary>
        /// Serializes a collection of <see cref="ContentRepository.Content"/> into JSON with the specified options.
        /// </summary>
