...
namespace Portal.Handlers
{
    ...
    public class XsltApplication : Application, IFile, IHttpHandler
    {
        ...
        {
            get { return Portal.UI.OutputCache.CanCache(this.CacheableForLoggedInUser); }
        }
        ...
        protected virtual string GetCacheKey()
        {
            ...
            return Portal.UI.OutputCache.GetCacheKey(this.CustomCacheKey, path, null, this.CacheByPath, this.CacheByParams, this.CacheByLanguage);
        }
        /// <summary>
        ...
        {
            return Portal.UI.OutputCache.GetCachedOutput(this.GetCacheKey());
        }
        protected virtual void InsertOutputIntoCache(string output)
        {
            ...
            Portal.UI.OutputCache.InsertOutputIntoCache(AbsoluteExpiration, SlidingExpirationMinutes, this.GetCacheKey(), output, dep, CacheItemPriority.Normal);
        }
