 ...
 * Remark: The original code is customized to fit in the portal layer of the 6.0.
 */
...
namespace Portal.Handlers
{
    public class TinyMCEGzipHandler : IHttpHandler
    {
        ...
        {
            //context.Response.Cache.SetExpires(DateTime.UtcNow.AddDays(_expiresOffset));
            //context.Response.Cache.SetCacheability(HttpCacheability.Public);
            Portal.Virtualization.HttpHeaderTools.SetCacheControlHeaders(
                httpCacheability: HttpCacheability.Public,
                maxAge: TimeSpan.FromDays(_expiresOffset));
