...
{
    /// <summary>
    ///     <para>Represents a web site in the Portal.</para>
    /// </summary>
    /// <remarks>
    ///     <para>In the ECMS (Enterprise Content Management) systems all the data and all the objects are handled as contents. Everything (like the web contents, web pages, but the portal users, your business data as well) is an enterprise content, and can be stored in the Content Repository. The Site class represents a web site that is stored in the content repository.</para>
    /// </remarks>
	[ContentHandler]
