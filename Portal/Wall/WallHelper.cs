    ...
    public class WallHelper
    {
        ...
        public static string GetMarkupString(string filePath)
        {
            ...
            using (new SystemAccount())
            {
                ...
                {
                    markupStr = Tools.GetStreamString(stream);
                }
        ...
        public static bool HasWallPermission(string workspacePath, Node workspace)
        {
            ...
            return checkedFolder.Security.HasPermission(ContentRepository.Storage.Schema.PermissionType.AddNew) && Portal.Wall.WallController.HasPermission();
        }
        ...
        {
            return commentNode.Security.HasPermission(ContentRepository.Storage.Schema.PermissionType.AddNew) && Portal.Wall.WallController.HasPermission();
        }
