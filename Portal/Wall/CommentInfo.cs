...
namespace Portal.Wall
{
    public class CommentInfo
    {
        ...
        public static int GetCommentCount(int parentId)
        {
            ...
            var result = ContentQuery.Query(ContentRepository.SafeQueries.InFolderAndTypeIsCountOnly, new QuerySettings { EnableAutofilters = FilterStatus.Disabled }, commentFolderPath, "Comment");
            return result.Count;
        }
    }
}
