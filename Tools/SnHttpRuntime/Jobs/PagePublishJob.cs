        ...
        public override Action<JobExecutionContext> Action
        {
            get
            {
                return context =>
                {
                    ...
                    var id = Guid.NewGuid();
                    Console.WriteLine("{0}\t{1} starts\t{2}", id, Name, DateTime.UtcNow.Ticks);
                    ...
                    if (!page.Locked)
                    {
                        ...
                        Console.WriteLine("{0}\t{1} ends\t{2}", id, Name, DateTime.UtcNow.Ticks);
                    }
                    else
                    {
                        ...
                        {
                            Console.WriteLine("{0}\tPage is locked ({1})\t{2}", id, Name, DateTime.UtcNow.Ticks);
                        }
