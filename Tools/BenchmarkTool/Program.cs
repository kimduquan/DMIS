...
namespace Benchmarking
{
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (PerformanceCounterCategory.Exists("Benchmark"))
                PerformanceCounterCategory.Delete("Benchmark");
        ...
        private static void InitializeCounterCategory()
        {
            if (!PerformanceCounterCategory.Exists("Benchmark"))
            {
                PerformanceCounterCategory.Create(
                    "Benchmark", "Performance counters of the Benchmark Tool.", PerformanceCounterCategoryType.SingleInstance,
        ...
        {
            _cpsPerfCounter = new PerformanceCounter("Benchmark", "CPS", false);
            _cpsPerfCounter.RawValue = 0;
            _cpsAvgPerfCounter = new PerformanceCounter("Benchmark", "CPSAVG", false);
            _cpsAvgPerfCounter.RawValue = 0;
            _cpsAvg20PerfCounter = new PerformanceCounter("Benchmark", "CPSAVG20", false);
