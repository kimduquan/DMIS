...
namespace Tools.EventLogCreator
{
    class Program
    {
        private static readonly string DEFAULT_LOG_NAME = "DMIS";
        private static readonly string DEFAULT_MACHINE_NAME = ".";
        private static readonly string DEFAULT_SOURCES = "Common,ContentRepository,Storage,Portal,CorePortlets,Services,WebSite";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Content Repository Tools - EventLog creator");
