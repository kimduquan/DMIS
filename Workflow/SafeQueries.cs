...
namespace Workflow
{
    public class SafeQueries : ISafeQueryHolder
    {
        ...
        public static string WorkflowsAutostartWhenCreated { get { return "+TypeIs:Workflow +InFolder:@0 +AutostartOnCreated:yes .AUTOFILTERS:OFF"; } }
        /// <summary>Returns with the following query: "+TypeIs:Workflow +InFolder:@0 +AutostartOnChanged:yes .AUTOFILTERS:OFF"</summary>
        public static string WorkflowsAutostartWhenChanged { get { return "+TypeIs:Workflow +InFolder:@0 +AutostartOnChanged:yes .AUTOFILTERS:OFF"; } }
        ...
        public static string WorkflowsAutostartWhenPublished { get { return "+TypeIs:Workflow +InFolder:@0 +(AutostartOnPublished:yes AutostartOnChanged:yes) .AUTOFILTERS:OFF"; } }
