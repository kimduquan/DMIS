...
namespace Portal.Portlets
{
    public class SyncObjectFromADPortlet : PortletBase
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            _btnCheck = new Button { Text = ResourceManager.Current.GetString("SyncObjectFromADPortlet", "CheckButtonText"), CssClass = "sn-submit" };
            _btnCheck.Click += new EventHandler(_btnCheck_Click);
            _btnSyncObject = new Button { Text = ResourceManager.Current.GetString("SyncObjectFromADPortlet", "SyncButtonText"), CssClass = "sn-submit" };
            _btnSyncObject.Click += new EventHandler(_btnSyncObject_Click);

            this.Controls.Add(new Literal { Text = ResourceManager.Current.GetString("SyncObjectFromADPortlet", "LdapLabel") });
        ...
        protected void _btnCheck_Click(object sender, EventArgs e)
        {
            ...
            {
                syncInfoStr = ResourceManager.Current.GetString("SyncObjectFromADPortlet", "SyncTreeNotFound");
            }
            else 
            {
                syncInfoStr = string.Format(ResourceManager.Current.GetString("SyncObjectFromADPortlet", "SyncTreeFound"),
                    syncInfo.SyncTreeADIPAddress,
                    syncInfo.SyncTreeADPath,
                    syncInfo.SyncTreePortalPath,
                    syncInfo.TargetPortalPath,
                    ResourceManager.Current.GetString("SyncObjectFromADPortlet", syncInfo.PortalNodeExists ? "TargetPathExists" : "TargetPathDoesNotExist"),
                    ResourceManager.Current.GetString("SyncObjectFromADPortlet", syncInfo.PortalParentExists ? "ParentPathExists" : "ParentPathDoesNotExist")
                    );
            }
            this.Controls.Add(new Literal { Text = string.Format("<hr/><strong>{0}:</strong><br/>", ResourceManager.Current.GetString("SyncObjectFromADPortlet", "Results")) });
        ...
        protected void _btnSyncObject_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (this.UseImpersonate)
                {
                    ...
                    {
                        this.Controls.Add(new Literal { Text = ResourceManager.Current.GetString("SyncObjectFromADPortlet", "IdentityImpersonationFailed") });
                        return;
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    this.Controls.Add(new Literal { Text = string.Format(ResourceManager.Current.GetString("SyncObjectFromADPortlet", "SyncError"), ex.Message) });
                }
                finally
                {
                    ...
                    if (noerrors)
                    {
                        ...
                        if (syncInfo.PortalNodeExists)
                            this.Controls.Add(new Literal { Text = string.Format(ResourceManager.Current.GetString("SyncObjectFromADPortlet", "CheckResults"), syncInfo.TargetPortalPath) });
                    }
                }
            }
            ...
            {
                Logger.WriteException(ex);
                this.Controls.Add(new Literal { Text = string.Format(ResourceManager.Current.GetString("SyncObjectFromADPortlet", "SyncErrorSecurity"), ex.Message) });
            }
            catch (Exception ex)
            {
                Logger.WriteException(ex);
                this.Controls.Add(new Literal { Text = string.Format(ResourceManager.Current.GetString("SyncObjectFromADPortlet", "SyncErrorException"), ex.Message) });
            }
        }
    }
}
