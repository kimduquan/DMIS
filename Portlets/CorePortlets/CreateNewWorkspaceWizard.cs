...
namespace Portal.Portlets
{
    ...
    {
        private const string CreateNewWorkspaceWizardClass = "CreateNewWorkspaceWizard";

        // Personalized properties ////////////////////////////////////////
        [WebBrowsable(true), Personalizable(true)]
        [LocalizedWebDisplayName(CreateNewWorkspaceWizardClass, "Prop_WorkspaceWizardUserControlPath_DisplayName")]
        [LocalizedWebDescription(CreateNewWorkspaceWizardClass, "Prop_WorkspaceWizardUserControlPath_Description")]
        ...
        {
            this.Name = "$CreateNewWorkspaceWizard:PortletDisplayName";
            this.Description = "$CreateNewWorkspaceWizard:PortletDescription";
