...
namespace Portal.Portlets
{
    ...
    {
        private const string ImportExportPortletClass = "ImportExportPortlet";

        private static readonly string PortletInfoFileNameExtension = ".portlet";

        [Personalizable(true)]
        [WebBrowsable(true)]
        [LocalizedWebDisplayName(ImportExportPortletClass, "Prop_PortletMode_DisplayName")]
        [LocalizedWebDescription(ImportExportPortletClass, "Prop_PortletMode_Description")]
        ...
        {
            this.Name = "$ImportExportPortlet:PortletDisplayName";
            this.Description = "$ImportExportPortlet:PortletDescription";
