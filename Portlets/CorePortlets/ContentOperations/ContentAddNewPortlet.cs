...
namespace Portal.Portlets
{
    public class ContentAddNewPortlet : ContextBoundPortlet, IContentProvider
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            if (_currentUserControl != null)
            {
                ...
                else
                {
                    ...
                    Logger.WriteError(Logger.EventId.NotDefined, string.Format("Forbidden content type ({0}) under {1}", contentTypeName, parentPath));

                    Controls.Add(new LiteralControl(string.Format("It is not allowed to add a new {0} here.", contentTypeName)));
        ...
        public override string FormatTitle(System.Globalization.CultureInfo cultureInfo, string titleFormat, string currentContentName)
        {
            ...
            titleFormat = ContentRepository.i18n.ResourceManager.Current.GetString("Portal", "AddNewContentUnder");
