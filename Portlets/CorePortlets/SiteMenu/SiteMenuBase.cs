            ...
            new[] 
                ...
                }.Select(node =>
                {
                    arguments.AddParam(node.Name, string.Empty,
                        new Services.ContentStore.Content(node.Value).ToXPathNavigator());
                    return true;
                }).ToArray();
            ...
            new[]
                    {
                     ...
                     new { Namespace = "sn://ContentRepository.i18n.ResourceXsltClient", Value = (object)new ResourceXsltClient() }
                    }.Select(ext =>
                    {
