...
namespace Portal.Portlets.ContentHandlers
{
    ...
    public class EventRegistrationFormItem : FormItem
    {
        ...
        protected override string CreateEmailText()
        {
            ...
            //{
            //    emailText = string.Concat(emailText, "\n");
            //    emailText = string.Concat(emailText, "\n\r\n", ResourceManager.Current.GetString("EventRegistration", "ToApprove"));
            //    emailText = string.Concat(emailText, "\n\r\n", GenerateApproveLink());
            //}
            ...
            if (!string.IsNullOrEmpty(emailHost))
            {
                ...
                if (parentForm != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(emailList))
                    {
                        ...
                        {
                            Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "AdminCancellingSubject"),
                    ...
                    if (!string.IsNullOrEmpty(submitterAddress))
                    {
                        ...
                        {
                            Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "UserCancellingSubject"),
                                      string.IsNullOrEmpty(parentForm.TitleSubmitter)
                                          ? EventTitle
                                          : ReplaceField(parentForm.TitleSubmitter, true, itemContent)),
                            Body = "Event registration cancelled",
            ...
            if (!string.IsNullOrEmpty(emailHost))
            {
                ...
                if (parentForm != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(emailList))
                    {
                        var ms = new MailMessage(from, emailList)
                        {
                            Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "AdminSubscriptionSubject"),
                                      string.IsNullOrEmpty(parentForm.TitleSubmitter)
                                          ? EventTitle
                                          : ReplaceField(parentForm.TitleSubmitter, true, itemContent)),
                    ...
                    if (!string.IsNullOrEmpty(submitterAddress))
                    {
                        ...
                        var ms = new MailMessage(fromField, submitterAddress)
                        {
                            Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "UserSubscriptionSubject"),
                                      string.IsNullOrEmpty(parentForm.TitleSubmitter)
                                          ? EventTitle
                                          : ReplaceField(parentForm.TitleSubmitter, true, itemContent)),
        ...
        private void CheckParticipantNumber(bool isApproving)
        {
            ...
            var maxPart = 0;
            var result = ContentQuery.Query("+TypeIs:calendarevent +RegistrationForm:@0", new QuerySettings { EnableAutofilters = FilterStatus.Disabled }, ParentId);
            if (result.Count == 0)
            ...
            if (overallWantedGuests > maxPart)
            {
                if (!isApproving)
                {
                    throw new Exception(String.Format(ResourceManager.Current.GetString("EventRegistration", "TooManyGuests"), maxPart - (overallWantedGuests - thisGuests)));
                }
                else
                {
                    throw new Exception(String.Format(ResourceManager.Current.GetString("EventRegistration", "TooManyParticipants"), maxPart - (overallWantedGuests - thisGuests - 1)));
                }
            }
            ...
            if (!string.IsNullOrEmpty(emailHost))
            {
                ...
                if (parentForm != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(emailList))
                    {
                        var ms = new MailMessage(from, emailList)
                                     {
                                         Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "AdminApprovingSubject"),
                                      string.IsNullOrEmpty(parentForm.TitleSubmitter)
                                          ? EventTitle
                                          : ReplaceField(parentForm.TitleSubmitter, true, itemContent)),
                                         Body = string.IsNullOrEmpty(parentForm.EmailTemplate)
                                                    ? CreateAdminemailText()
                                                    : ResourceManager.Current.GetString("EventRegistration", "AdminApprovingBody")
                                     };
                    ...
                    if (!string.IsNullOrEmpty(submitterAddress))
                    {
                        ...
                        var ms = new MailMessage(fromField, submitterAddress)
                                     {
                                         Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "UserApprovingSubject"),
                                      string.IsNullOrEmpty(parentForm.TitleSubmitter)
                                          ? EventTitle
                                          : ReplaceField(parentForm.TitleSubmitter, true, itemContent)),
                                         Body = string.IsNullOrEmpty(parentForm.EmailTemplateSubmitter)
                                                    ? CreateEmailText()
                                                    : ResourceManager.Current.GetString("EventRegistration", "UserApprovingBody"),
                                         IsBodyHtml = !string.IsNullOrEmpty(parentForm.EmailTemplateSubmitter)
                                     };
            ...
            if (!string.IsNullOrEmpty(emailHost))
            {
                ...
                if (parentForm != null)
                {
                    ...
                    if (!string.IsNullOrEmpty(emailList))
                    {
                        var ms = new MailMessage(from, emailList)
                        {
                            Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "AdminRejectingSubject"),
                                      string.IsNullOrEmpty(parentForm.TitleSubmitter)
                                          ? EventTitle
                                          : ReplaceField(parentForm.TitleSubmitter, true, itemContent)),
                            Body = string.IsNullOrEmpty(parentForm.EmailTemplate)
                                       ? CreateAdminemailText()
                                       : ResourceManager.Current.GetString("EventRegistration", "AdminRejectingBody")
                        };
                    ...
                    if (!string.IsNullOrEmpty(submitterAddress))
                    {
                        ...
                        var ms = new MailMessage(fromField, submitterAddress)
                        {
                            Subject = String.Format(ResourceManager.Current.GetString("EventRegistration", "UserRejectingSubject"),
                                      string.IsNullOrEmpty(parentForm.TitleSubmitter)
                                          ? EventTitle
                                          : ReplaceField(parentForm.TitleSubmitter, true, itemContent)),
                            Body = string.IsNullOrEmpty(parentForm.EmailTemplateSubmitter)
                                       ? CreateEmailText()
                                       : ResourceManager.Current.GetString("EventRegistration", "UserRejectingBody"),
                            IsBodyHtml = !string.IsNullOrEmpty(parentForm.EmailTemplateSubmitter)
                        };
