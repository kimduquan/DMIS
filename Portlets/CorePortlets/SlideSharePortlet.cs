...
namespace Portal.Portlets
{
    public class SlideSharePortlet : CacheablePortlet, IWebEditable 
    {
        ...
        {
            this.Name = "$SlideSharePortlet:PortletTitle";
            this.Description = "$SlideSharePortlet:PortletDescription";
        ...
        protected override void Render(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            {
                writer.Write(ResourceManager.Current.GetString("SlideSharePortlet", "CodeForHere"));
            }
            else
            {
                ...
                {
                    writer.Write(ResourceManager.Current.GetString("SlideSharePortlet", "WrongCode"));
                    return;
                }
            }
            writer.Write(Html);
