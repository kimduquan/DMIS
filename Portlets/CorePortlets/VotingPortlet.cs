...
namespace Portal.Portlets
{
    public class VotingPortlet : ContextBoundPortlet
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "ContextNodePermissionError") });
                return;
            }
            ...
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "ContextNodeError") });
                return;
            }
            ...
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "BindingError") });
                return;
            }
            ...
            else if (VotingPortletMode == PortletMode.VotingOnly)
            {
                switch (_myState)
                {
                    ...
                    case "ThankYouView":
                        ...
                        break;
                    default:
                        Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "VotingOnlyError") });
                        break;
                }
            }
            ...
            else if (VotingPortletMode == PortletMode.VoteAndGotoResult)
            {
                switch (_myState)
                {
                    ...
                    case "ThankYouView":
                        ...
                        break;
                    default:
                        Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "VoteAndGotoResultError") });
                        break;
                }
            }
            ...
            else if (VotingPortletMode == PortletMode.ResultAndVoting)
            {
                switch (_myState)
                {
                    ...
                    default:
                        Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "ResultAndVotingError") });
                        break;
                }
            }
        ...
        private void AddVotingView()
        {
            ...
            if (votingNode.IsVotingAvailable)
            {
                ...
                if (votingView != null)
                {
                    ...
                    if (contentView == null)
                    {
                        Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "ContentViewCreateError") });
                        return;
                    }
                    ...
                    {
                        Controls.Clear();
                        Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "PlaceHolderError") });
                        return;
                    }
                    ...
                    if (!isQuestionExist)
                    {
                        Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "NoQuestion") });
                        return;
                    }
                ...
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "NoContentView") });
            }
            else
            {
                // When the user can only Vote once
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "OnlyOneVoteError") });
            }
        }
        ...
        private void AddResultView()
        {
            ...
            if (!IsResultAvalaibleBefore && VotingPortletMode == PortletMode.ResultOnly)
            {
                ...
                if (c == null)
                {
                    Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "ContentCreateError") });
                    return;
                }
            ...
            else
            {
                ...
                if (resultView != null)
                {
                    ...
                    if (MoreFilingIsEnabled && UserVoted && VotingPortletMode == PortletMode.VoteAndGotoResult)
                    {
                        ...
                        lb.Text = ResourceManager.Current.GetString("Voting", "GoToVotingLink");
                ...
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "NoResult") });
            }
        }
        ...
        private void AddThankYouView()
        {
            ...
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "LandingPageError") });
                return;
            }
        ...
        private void AddInvalidView()
        {
            ...
            {
                Controls.Add(new Literal { Text = ResourceManager.Current.GetString("Voting", "InvalidSurveyPageError") });
                return;
            }
