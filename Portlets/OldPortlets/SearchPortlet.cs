...
namespace Portal.Portlets
{
	...
	{
        private const string SearchPortletClass = "SearchPortlet";
        ...
        [LocalizedWebDisplayName(SearchPortletClass, "Prop_ExtraQueryXML_DisplayName")]
        [LocalizedWebDescription(SearchPortletClass, "Prop_ExtraQueryXML_Description")]
		...
		[WebBrowsable(true), Personalizable(true)]
        [LocalizedWebDisplayName(SearchPortletClass, "Prop_FullQueryXML_DisplayName")]
        [LocalizedWebDescription(SearchPortletClass, "Prop_FullQueryXML_Description")]
        [WebCategory(EditorCategory.Search, EditorCategory.Search_Order)]
        [WebOrder(20)]
        [Editor(typeof(TextEditorPartField), typeof(IEditorPartField))]
        [TextEditorPartOptions(TextEditorCommonType.MultiLine)]
        ...
        [WebBrowsable(true), Personalizable(true)]
        [LocalizedWebDisplayName(SearchPortletClass, "Prop_PageSize_DisplayName")]
        [LocalizedWebDescription(SearchPortletClass, "Prop_PageSize_Description")]
        [WebCategory(EditorCategory.Search, EditorCategory.Search_Order)]
        [WebOrder(30)]
        [Editor(typeof(TextEditorPartField), typeof(IEditorPartField))]
        ...
        [LocalizedWebDisplayName(SearchPortletClass, "Prop_SearchPaneMode_DisplayName")]
        [WebCategory(EditorCategory.Search, EditorCategory.Search_Order)]
        [WebOrder(40)]
        ...
        [WebBrowsable(true), Personalizable(true)]
        [LocalizedWebDisplayName(SearchPortletClass, "Prop_CvFolderPath_DisplayName")]
        [LocalizedWebDescription(SearchPortletClass, "Prop_CvFolderPath_Description")]
        [WebCategory(EditorCategory.Search, EditorCategory.Search_Order)]
        [WebOrder(50)]
        ...
        [WebBrowsable(true), Personalizable(true)]
        [LocalizedWebDisplayName(SearchPortletClass, "Prop_AllowEmptySearch_DisplayName")]
        [LocalizedWebDescription(SearchPortletClass, "Prop_AllowEmptySearch_Description")]
        [WebCategory(EditorCategory.Search, EditorCategory.Search_Order)]
        [WebOrder(60)]
        ...
        [WebBrowsable(true), Personalizable(true)]
        [LocalizedWebDisplayName(SearchPortletClass, "Prop_IsSystemAccount_DisplayName")]
        [LocalizedWebDescription(SearchPortletClass, "Prop_IsSystemAccount_Description")]
        [WebCategory(EditorCategory.Search, EditorCategory.Search_Order)]
        [WebOrder(70)]
        ...
        {
            this.Name = "$SearchPortlet:PortletDisplayName";
            this.Description = "$SearchPortlet:PortletDescription";
		...
		private List<Node> RunSearch(string queryString)
		{
			...
			if (string.IsNullOrEmpty(FullQueryXML))
			{
                ...
                //queryXML.AppendLine(string.Concat("    <String op=\"StartsWith\" property=\"Path\">", Portal.Virtualization.PortalContext.Current.Site.Path, "</String>"));
		...
		{
			string url = Portal.Virtualization.PortalContext.Current.OriginalUri.AbsoluteUri;
			string query = Portal.Virtualization.PortalContext.Current.OriginalUri.Query;
