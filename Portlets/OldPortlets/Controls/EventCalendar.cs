                ...
                foreach (var item in CalendarEvents)
                {
                    ...
                    if (eventStartDate <= selectedDate && selectedDate <= eventEndDate)
                    {
                        ...
                        if (Convert.ToBoolean(item["RequiresRegistration"]))
                        {
                            ...
                            var partText = String.Format(ResourceManager.Current.GetString("EventCalendar", "ParticipantsText"),
                            ...
                            if (maxParticipants > numParticipants)
                            {
                                if (isSubscribed)
                                {
                                    ...
                                    myNewEvent.EventText = ResourceManager.Current.GetString("EventCalendar", "AlreadyApplied");
                                ...
                                else
                                {
                                    ...
                                    myNewEvent.EventText = ResourceManager.Current.GetString("EventCalendar", "ApplyText");
                            ...
                            else if (numParticipants == maxParticipants)
                            {
                                ...
                                myNewEvent.EventText = ResourceManager.Current.GetString("EventCalendar", "FullEventText");
                                if (isSubscribed)
                                {
                        ...
                        else
                        {
                            ...
                            myNewEvent.EventText = ResourceManager.Current.GetString("EventCalendar", "DontNeedRegistration");
                        }
